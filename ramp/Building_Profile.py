...
Buildings = [34,28,19,20,18,35,25,5,6]
...
building_basic_loads = {
    ...
    5: 0,           # Building 5 with base load of 4.11 kW
    6: 3.79         # Building 6 with base load of 3.79 kW
...
plt.title(f'Load Profile of Building {Building}', fontsize=14, fontweight='bold')
plt.xlabel('Months', fontsize=12, fontweight='bold')
plt.ylabel('Power Consumption (kWh)', fontsize=12, fontweight='bold')
plt.ylim(0)
plt.grid(axis='y', linestyle='-') 
plt.tight_layout()
plt.show()
plt.legend(['Scaled Power','Calculated Power','2021','2022','2023'],loc='lower right') 
# plt.savefig(f'Load Profile of Building {Building}.jpeg',bbox_inches='tight')

plt.figure(figsize=(16,8))
final_df['Scaled Power Consumption'].plot(color='yellow', drawstyle = 'steps-post')
plt.title(f'Load Profile of Building {Building}' , fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.show()
#plt.savefig(f'Hourly Load Profile of Building {Building}.jpeg',bbox_inches='tight')
