...
EP_bulb_living = EP.Appliance(EP,1,10,1,60,v3,60, wd_we_type = 0)
EP_bulb_living.windows(t1,t0,v1)

EP_bulb_living = EP.Appliance(EP,1,10,1,210,v3,210, wd_we_type = 0)
...
EP_bulb_BT_hallway = EP.Appliance(EP,1,10,1,30,0.3,15, wd_we_type = 0)
...
EP_outdoor_bulb.windows(t1_out,t0,0)
...
EP_bulb_living = EP.Appliance(EP,1,10,2,210,v3,210, wd_we_type = 1)
...
EP_bulb_BT_hallway = EP.Appliance(EP,1,10,1,30,0.3,30, wd_we_type = 1)
EP_bulb_BT_hallway.windows(t11,t0,v1)

EP_bulb_BT_hallway = EP.Appliance(EP,1,10,2,30,0.3,30, wd_we_type = 1)
...
POK_bulb_living = POK.Appliance(POK,2,10,1,60,v3,60, wd_we_type = 0)
POK_bulb_living.windows(t1,t0,v1)

POK_bulb_living = POK.Appliance(POK,2,10,1,210,v3,210, wd_we_type = 0)
...
POK_bulb2_bedroom = POK.Appliance(POK,1,10,1,20,v3,20, wd_we_type = 0)
POK_bulb2_bedroom.windows([1140,1320],t0,v1)

POK_bulb_BT_hallway = POK.Appliance(POK,2,10,1,15,0.3,10, wd_we_type = 0)
POK_bulb_BT_hallway.windows(t1,t0,v1)

POK_bulb_BT_hallway = POK.Appliance(POK,2,10,1,20,0.3,10, wd_we_type = 0)
POK_bulb_BT_hallway.windows(t22,t0,0)

POK_outdoor_bulb = POK.Appliance(POK,1,13,1,5,v3,5, wd_we_type = 0)   
POK_outdoor_bulb.windows(t1_out,t0,0)
...
POK_bulb_living = POK.Appliance(POK,2,10,2,210,v3,210, wd_we_type = 1)
...
POK_bulb2_bedroom = POK.Appliance(POK,1,10,1,20,v3,20, wd_we_type = 1)
POK_bulb2_bedroom.windows([1080,1320],t0,0)

POK_bulb_BT_hallway = POK.Appliance(POK,2,10,1,15,0.3,10, wd_we_type = 1)
POK_bulb_BT_hallway.windows(t11,t0,v1)

POK_bulb_BT_hallway = POK.Appliance(POK,2,10,2,20,0.3,10, wd_we_type = 1)
...
PMK_bulb_living = PMK.Appliance(PMK,3,10,1,210,v3,210, wd_we_type = 0)
...
PMK_bulb2_bedroom = PMK.Appliance(PMK,1,10,1,15,v3,15, wd_we_type = 0)
PMK_bulb2_bedroom.windows([1080,1140],t0,v1)

PMK_bulb2_bedroom = PMK.Appliance(PMK,1,10,1,30,v3,30, wd_we_type = 0)
PMK_bulb2_bedroom.windows(t2,t0,v1)

PMK_bulb_BT_hallway = PMK.Appliance(PMK,2,10,1,15,0.3,10, wd_we_type = 0)
PMK_bulb_BT_hallway.windows(t1,t0,v1)

PMK_bulb_BT_hallway = PMK.Appliance(PMK,2,10,1,20,0.3,10, wd_we_type = 0)
PMK_bulb_BT_hallway.windows(t22,t0,0)

PMK_outdoor_bulb = PMK.Appliance(PMK,2,13,1,5,v3,5, wd_we_type = 0)  
PMK_outdoor_bulb.windows(t1_out,t0,0)
...
PMK_bulb_living = PMK.Appliance(PMK,3,10,2,210,v3,210, wd_we_type = 1)
...
PMK_bulb2_bedroom = PMK.Appliance(PMK,1,10,1,30,v3,30, wd_we_type = 1)
PMK_bulb2_bedroom.windows([1080,1320],t0,0)

PMK_bulb2_bedroom = PMK.Appliance(PMK,1,10,2,30,v3,30, wd_we_type = 1)
PMK_bulb2_bedroom.windows(t2,th,v1)

PMK_bulb_BT_hallway = PMK.Appliance(PMK,2,10,1,15,0.3,10, wd_we_type = 1)
PMK_bulb_BT_hallway.windows(t11,t0,v1)

PMK_bulb_BT_hallway = PMK.Appliance(PMK,2,10,2,20,0.3,10, wd_we_type = 1)
PMK_bulb_BT_hallway.windows(CTF,th,0)

PMK_outdoor_bulb = PMK.Appliance(PMK,2,13,1,10,v3,10, wd_we_type = 1)   
PMK_outdoor_bulb.windows(t1_out,t0,0)

PMK_outdoor_bulb = PMK.Appliance(PMK,2,13,2,15,v3,15, wd_we_type = 1)  
...
MP_bulb_living = MP.Appliance(MP,4,10,1,210,v3,210, wd_we_type = 0)
...
MP_bulb2_bedroom = MP.Appliance(MP,1,10,1,15,v3,15, wd_we_type = 0)
MP_bulb2_bedroom.windows([1080,1140],t0,v1)
...
MP_bulb_BT_hallway = MP.Appliance(MP,3,10,1,20,0.3,10, wd_we_type = 0)
...
MP_outdoor_bulb.windows(t1_out,t0,0)
...
MP_bulb_living = MP.Appliance(MP,4,10,2,210,v3,210, wd_we_type = 1)
...
MP_bulb2_bedroom = MP.Appliance(MP,1,10,1,30,v3,30, wd_we_type = 1)
MP_bulb2_bedroom.windows([1080,1320],t0,0)
...
MP_bulb_BT_hallway = MP.Appliance(MP,3,10,1,20,0.3,10, wd_we_type = 1)
MP_bulb_BT_hallway.windows(t11,t0,v1)

MP_bulb_BT_hallway = MP.Appliance(MP,3,10,2,20,0.3,10, wd_we_type = 1)
