...
AE_bulb_living = AE.Appliance(AE,1,10,1,30,0.5,30, wd_we_type = 0)
AE_bulb_living.windows(t1,t0,v1)

AE_bulb_living = AE.Appliance(AE,1,10,1,90,0.5,90, wd_we_type = 0)
AE_bulb_living.windows(t12,t0,v1)

AE_bulb_kitchen = AE.Appliance(AE,1,10,1,15,v1,15, wd_we_type = 0)
AE_bulb_kitchen.windows(t1,t0,v1)

AE_bulb_kitchen = AE.Appliance(AE,1,10,1,45,v1,45, wd_we_type = 0)
AE_bulb_kitchen.windows(tk,t0,v1)

AE_bulb1_bedroom = AE.Appliance(AE,1,10,1,30,v1,30, wd_we_type = 0)
AE_bulb1_bedroom.windows(t1,t0,v1)

AE_bulb1_bedroom = AE.Appliance(AE,1,10,1,30,v1,30, wd_we_type = 0)
AE_bulb1_bedroom.windows(t12,t0,v1)

AE_bulb_BT_hallway = AE.Appliance(AE,1,10,1,5,0.25,5, wd_we_type = 0)
AE_bulb_BT_hallway.windows(t1,t0,v1)

AE_bulb_BT_hallway = AE.Appliance(AE,1,10,1,25,0.25,15, wd_we_type = 0)
AE_bulb_BT_hallway.windows(t12,t0,v1)

AE_outdoor_bulb = AE.Appliance(AE,1,13,1,5,v1,5, wd_we_type = 0)   
AE_outdoor_bulb.windows(t12,t0,0)
...
AE_Phone_charger.windows(t11,t0,0)
...
AE_Laptop_PC_charger.windows(t11,t0,0)
...
AE_bulb_living = AE.Appliance(AE,1,10,2,120,0.5,120, wd_we_type = 1)
AE_bulb_living.windows(t12,th,v1)

AE_bulb_kitchen = AE.Appliance(AE,1,10,1,60,v1,60, wd_we_type = 1)
AE_bulb_kitchen.windows(tk,t0,v1)

AE_bulb1_bedroom = AE.Appliance(AE,1,10,2,60,v1,60, wd_we_type = 1)
AE_bulb1_bedroom.windows(t12,th,v1)

AE_bulb_BT_hallway = AE.Appliance(AE,1,10,2,30,0.25,15, wd_we_type = 1)
AE_bulb_BT_hallway.windows(t12,th,v1)

AE_outdoor_bulb = AE.Appliance(AE,1,13,2,5,v1,5, wd_we_type = 1)  
AE_outdoor_bulb.windows(t12,th,v1)
...
POK_bulb_living = POK.Appliance(POK,2,10,1,30,0.5,30, wd_we_type = 0)
POK_bulb_living.windows(t1,t0,v1)

POK_bulb_living = POK.Appliance(POK,2,10,1,90,0.5,90, wd_we_type = 0)
POK_bulb_living.windows(t12,t0,v1)

POK_bulb_kitchen = POK.Appliance(POK,1,10,1,15,v1,15, wd_we_type = 0)
POK_bulb_kitchen.windows(t1,t0,v1)

POK_bulb_kitchen = POK.Appliance(POK,1,10,1,45,v1,45, wd_we_type = 0)
POK_bulb_kitchen.windows(tk,t0,v1)

POK_bulb1_bedroom = POK.Appliance(POK,1,10,1,30,v1,30, wd_we_type = 0)
POK_bulb1_bedroom.windows(t1,t0,v1)

POK_bulb1_bedroom = POK.Appliance(POK,1,10,1,30,v1,30, wd_we_type = 0)
POK_bulb1_bedroom.windows(t12,t0,v1)

POK_bulb2_bedroom = POK.Appliance(POK,1,10,1,5,v1,5, wd_we_type = 0)
POK_bulb2_bedroom.windows(t12,t0,v1)

POK_bulb_BT_hallway = POK.Appliance(POK,2,10,1,5,0.25,5, wd_we_type = 0)
POK_bulb_BT_hallway.windows(t1,t0,v1)

POK_bulb_BT_hallway = POK.Appliance(POK,2,10,1,15,0.25,15, wd_we_type = 0)
POK_bulb_BT_hallway.windows(t12,t0,v1)

POK_outdoor_bulb = POK.Appliance(POK,1,13,1,5,v1,5, wd_we_type = 0)   
POK_outdoor_bulb.windows(t12,t0,0)
...
POK_Phone_charger.windows(t11,t0,0)
...
POK_Laptop_PC_charger.windows(t11,t0,0)
...
POK_bulb_living = POK.Appliance(POK,2,10,2,120,0.5,120, wd_we_type = 1)
POK_bulb_living.windows(t12,th,v1)

POK_bulb_kitchen = POK.Appliance(POK,1,10,1,60,v1,60, wd_we_type = 1)
POK_bulb_kitchen.windows(tk,t0,v1)

POK_bulb1_bedroom = POK.Appliance(POK,1,10,2,60,v1,60, wd_we_type = 1)
POK_bulb1_bedroom.windows(t12,th,v1)

POK_bulb2_bedroom = POK.Appliance(POK,1,10,2,5,v1,5, wd_we_type = 1)
POK_bulb2_bedroom.windows(t12,th,v1)

POK_bulb_BT_hallway = POK.Appliance(POK,2,10,2,20,0.25,20, wd_we_type = 1)
POK_bulb_BT_hallway.windows(t12,th,v1)

POK_outdoor_bulb = POK.Appliance(POK,1,13,2,5,v1,5, wd_we_type = 1)  
POK_outdoor_bulb.windows(t12,th,v1)
...
PMK_bulb_living = PMK.Appliance(PMK,3,10,1,30,0.5,30, wd_we_type = 0)
PMK_bulb_living.windows(t1,t0,v1)

PMK_bulb_living = PMK.Appliance(PMK,3,10,1,90,0.5,90, wd_we_type = 0)
PMK_bulb_living.windows(t12,t0,v1)

PMK_bulb_kitchen = PMK.Appliance(PMK,1,10,1,15,v1,15, wd_we_type = 0)
PMK_bulb_kitchen.windows(t1,t0,v1)

PMK_bulb_kitchen = PMK.Appliance(PMK,1,10,1,45,v1,45, wd_we_type = 0)
PMK_bulb_kitchen.windows(tk,t0,v1)

PMK_bulb1_bedroom = PMK.Appliance(PMK,1,10,1,30,v1,30, wd_we_type = 0)
PMK_bulb1_bedroom.windows(t1,t0,v1)

PMK_bulb1_bedroom = PMK.Appliance(PMK,1,10,1,30,v1,30, wd_we_type = 0)
PMK_bulb1_bedroom.windows(t12,t0,v1)

PMK_bulb2_bedroom = PMK.Appliance(PMK,1,10,1,30,v1,30, wd_we_type = 0)
PMK_bulb2_bedroom.windows(t1,t0,v1)

PMK_bulb2_bedroom = PMK.Appliance(PMK,1,10,1,30,v1,30, wd_we_type = 0)
PMK_bulb2_bedroom.windows(t12,t0,v1)

PMK_bulb_BT_hallway = PMK.Appliance(PMK,2,10,1,5,0.25,5, wd_we_type = 0)
PMK_bulb_BT_hallway.windows(t1,t0,v1)

PMK_bulb_BT_hallway = PMK.Appliance(PMK,2,10,1,15,0.25,15, wd_we_type = 0)
PMK_bulb_BT_hallway.windows(t12,t0,v1)

PMK_outdoor_bulb = PMK.Appliance(PMK,2,13,1,5,v1,5, wd_we_type = 0)   
PMK_outdoor_bulb.windows(t12,t0,0)
...
PMK_Phone_charger.windows(t11,t0,0)
...
PMK_Laptop_PC_charger.windows(t11,t0,0)
...
PMK_bulb_living = PMK.Appliance(PMK,3,10,2,120,0.5,120, wd_we_type = 1)
PMK_bulb_living.windows(t12,th,v1)

PMK_bulb_kitchen = PMK.Appliance(PMK,1,10,1,60,v1,60, wd_we_type = 1)
PMK_bulb_kitchen.windows(tk,t0,v1)

PMK_bulb1_bedroom = PMK.Appliance(PMK,1,10,2,60,v1,60, wd_we_type = 1)
PMK_bulb1_bedroom.windows(t12,th,v1)

PMK_bulb2_bedroom = PMK.Appliance(PMK,1,10,2,60,v1,60, wd_we_type = 1)
PMK_bulb2_bedroom.windows(t12,th,v1)

PMK_bulb_BT_hallway = PMK.Appliance(PMK,2,10,2,20,0.25,20, wd_we_type = 1)
PMK_bulb_BT_hallway.windows(t12,th,v1)

PMK_outdoor_bulb = PMK.Appliance(PMK,2,13,2,5,v1,5, wd_we_type = 1)  
PMK_outdoor_bulb.windows(t12,th,v1)
...
MP_bulb_living = MP.Appliance(MP,4,10,1,30,0.5,30, wd_we_type = 0)
MP_bulb_living.windows(t1,t0,v1)

MP_bulb_living = MP.Appliance(MP,4,10,1,90,0.5,90, wd_we_type = 0)
MP_bulb_living.windows(t12,t0,v1)

MP_bulb_kitchen = MP.Appliance(MP,2,10,1,15,v1,15, wd_we_type = 0)
MP_bulb_kitchen.windows(t1,t0,v1)

MP_bulb_kitchen = MP.Appliance(MP,2,10,1,45,v1,45, wd_we_type = 0)
MP_bulb_kitchen.windows(tk,t0,v1)

MP_bulb1_bedroom = MP.Appliance(MP,1,10,1,30,v1,30, wd_we_type = 0)
MP_bulb1_bedroom.windows(t1,t0,v1)

MP_bulb1_bedroom = MP.Appliance(MP,1,10,1,30,v1,30, wd_we_type = 0)
MP_bulb1_bedroom.windows(t12,t0,v1)

MP_bulb2_bedroom = MP.Appliance(MP,1,10,1,30,v1,30, wd_we_type = 0)
MP_bulb2_bedroom.windows(t1,t0,v1)

MP_bulb2_bedroom = MP.Appliance(MP,1,10,1,30,v1,30, wd_we_type = 0)
MP_bulb2_bedroom.windows(t12,t0,v1)

MP_bulb3_bedroom = MP.Appliance(MP,1,10,1,30,v1,30, wd_we_type = 0)
MP_bulb3_bedroom.windows(t1,t0,v1)

MP_bulb3_bedroom = MP.Appliance(MP,1,10,1,30,v1,30, wd_we_type = 0)
MP_bulb3_bedroom.windows(t12,t0,v1)

MP_bulb_BT_hallway = MP.Appliance(MP,3,10,1,5,0.25,5, wd_we_type = 0)
MP_bulb_BT_hallway.windows(t1,t0,v1)

MP_bulb_BT_hallway = MP.Appliance(MP,3,10,1,15,0.25,15, wd_we_type = 0)
MP_bulb_BT_hallway.windows(t12,t0,v1)

MP_outdoor_bulb = MP.Appliance(MP,2,13,1,5,v1,5, wd_we_type = 0)   
MP_outdoor_bulb.windows(t12,t0,0)
...
MP_Phone_charger.windows(t11,t0,0)
...
MP_Laptop_PC_charger.windows(t11,t0,0)
...
MP_bulb_living = MP.Appliance(MP,4,10,2,120,0.5,120, wd_we_type = 1)
MP_bulb_living.windows(t12,th,v1)

MP_bulb_kitchen = MP.Appliance(MP,2,10,1,60,v1,60, wd_we_type = 1)
MP_bulb_kitchen.windows(tk,t0,v1)

MP_bulb1_bedroom = MP.Appliance(MP,1,10,2,60,v1,60, wd_we_type = 1)
MP_bulb1_bedroom.windows(t12,th,v1)

MP_bulb2_bedroom = MP.Appliance(MP,1,10,2,60,v1,60, wd_we_type = 1)
MP_bulb2_bedroom.windows(t12,th,v1)

MP_bulb3_bedroom = MP.Appliance(MP,1,10,2,60,v1,60, wd_we_type = 1)
MP_bulb3_bedroom.windows(t12,th,v1)

MP_bulb_BT_hallway = MP.Appliance(MP,3,10,2,20,0.25,20, wd_we_type = 1)
MP_bulb_BT_hallway.windows(t12,th,v1)

MP_outdoor_bulb = MP.Appliance(MP,2,13,2,5,v1,5, wd_we_type = 1)  
MP_outdoor_bulb.windows(t12,th,v1)
