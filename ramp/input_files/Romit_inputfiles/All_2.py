...
EP_bulb_living = EP.Appliance(EP,1,10,1,30,v3,30, wd_we_type = 0)
EP_bulb_living.windows(t1,t0,v1)

EP_bulb_living = EP.Appliance(EP,1,10,1,150,v3,150, wd_we_type = 0)
EP_bulb_living.windows(t22,t0,0)

EP_bulb_kitchen = EP.Appliance(EP,1,10,1,30,v3,30, wd_we_type = 0)
EP_bulb_kitchen.windows(t1,t0,v1)

EP_bulb_kitchen = EP.Appliance(EP,1,10,1,70,v3,70, wd_we_type = 0)
...
EP_bulb_BT_hallway = EP.Appliance(EP,1,10,1,30,0.25,15, wd_we_type = 0)
EP_bulb_BT_hallway.windows(t1,t0,v1)

EP_bulb_BT_hallway = EP.Appliance(EP,1,10,1,30,0.25,15, wd_we_type = 0)
EP_bulb_BT_hallway.windows(t22,t0,0)

EP_outdoor_bulb = EP.Appliance(EP,1,13,1,5,v3,5, wd_we_type = 0)  
EP_outdoor_bulb.windows(t_out,t0,0)

EP_outdoor_bulb = EP.Appliance(EP,1,13,1,5,v3,5, wd_we_type = 0)   
EP_outdoor_bulb.windows(t22,t0,0)
...
EP_Phone_charger.windows(t1,t0,0)
...
EP_Laptop_PC_charger.windows(t1,t0,0)
...
EP_bulb_living = EP.Appliance(EP,1,10,1,30,v3,30, wd_we_type = 1)
EP_bulb_living.windows(t11,t0,v1)

EP_bulb_living = EP.Appliance(EP,1,10,2,150,v3,150, wd_we_type = 1)
EP_bulb_living.windows(t22,th,0)

EP_bulb_kitchen = EP.Appliance(EP,1,10,2,100,v3,100, wd_we_type = 1)
EP_bulb_kitchen.windows(t22,th,0)

EP_bulb1_bedroom = EP.Appliance(EP,1,10,1,30,v3,30, wd_we_type = 1)
EP_bulb1_bedroom.windows(t11,t0,v1)

EP_bulb1_bedroom = EP.Appliance(EP,1,10,2,30,v3,30, wd_we_type = 1)
EP_bulb1_bedroom.windows(t2,th,v1)

EP_bulb_BT_hallway = EP.Appliance(EP,1,10,1,30,0.25,15, wd_we_type = 1)
EP_bulb_BT_hallway.windows(t11,t0,v1)

EP_bulb_BT_hallway = EP.Appliance(EP,1,10,2,30,0.25,15, wd_we_type = 1)
EP_bulb_BT_hallway.windows(t22,th,0)

EP_outdoor_bulb = EP.Appliance(EP,1,13,1,5,v3,5, wd_we_type = 1)   
EP_outdoor_bulb.windows(t_out,t0,0)

EP_outdoor_bulb = EP.Appliance(EP,1,13,2,10,v3,10, wd_we_type = 1)  
EP_outdoor_bulb.windows(t22,th,0)
...
AE_bulb_living = AE.Appliance(AE,1,10,1,30,v3,30, wd_we_type = 0)
AE_bulb_living.windows(t1,t0,v1)

AE_bulb_living = AE.Appliance(AE,1,10,1,150,v3,150, wd_we_type = 0)
...
AE_bulb_kitchen = AE.Appliance(AE,1,10,1,70,v3,70, wd_we_type = 0)
...
AE_bulb_BT_hallway = AE.Appliance(AE,1,10,1,30,0.25,15, wd_we_type = 0)
...
AE_outdoor_bulb = AE.Appliance(AE,1,13,1,5,v3,5, wd_we_type = 0)   
AE_outdoor_bulb.windows(t22,t0,0)
...
AE_bulb_living = AE.Appliance(AE,1,10,1,30,v3,30, wd_we_type = 1)
AE_bulb_living.windows(t11,t0,v1)

AE_bulb_living = AE.Appliance(AE,1,10,2,150,v3,150, wd_we_type = 1)
AE_bulb_living.windows(t22,th,0)

AE_bulb_kitchen = AE.Appliance(AE,1,10,2,100,v3,100, wd_we_type = 1)
...
AE_bulb_BT_hallway = AE.Appliance(AE,1,10,1,30,0.25,15, wd_we_type = 1)
AE_bulb_BT_hallway.windows(t11,t0,v1)

AE_bulb_BT_hallway = AE.Appliance(AE,1,10,2,30,0.25,15, wd_we_type = 1)
AE_bulb_BT_hallway.windows(t22,th,0)

AE_outdoor_bulb = AE.Appliance(AE,1,13,1,5,v3,5, wd_we_type = 1)   
AE_outdoor_bulb.windows(t_out,t0,0)

AE_outdoor_bulb = AE.Appliance(AE,1,13,2,15,v3,15, wd_we_type = 1)  
AE_outdoor_bulb.windows(t22,th,0)
...
POK_bulb_living = POK.Appliance(POK,2,10,1,30,v3,30, wd_we_type = 0)
POK_bulb_living.windows(t1,t0,v1)

POK_bulb_living = POK.Appliance(POK,2,10,1,150,v3,150, wd_we_type = 0)
POK_bulb_living.windows(t22,t0,0)

POK_bulb_kitchen = POK.Appliance(POK,1,10,1,30,v3,30, wd_we_type = 0)
POK_bulb_kitchen.windows(t1,t0,v1)

POK_bulb_kitchen = POK.Appliance(POK,1,10,1,70,v3,70, wd_we_type = 0)
...
POK_bulb2_bedroom = POK.Appliance(POK,1,10,1,10,v3,10, wd_we_type = 0)
POK_bulb2_bedroom.windows([1140,1320],t0,v1)

POK_bulb_BT_hallway = POK.Appliance(POK,2,10,1,100,0.25,10, wd_we_type = 0)
POK_bulb_BT_hallway.windows(t1,t0,v1)

POK_bulb_BT_hallway = POK.Appliance(POK,2,10,1,20,0.25,10, wd_we_type = 0)
POK_bulb_BT_hallway.windows(t22,t0,0)

POK_outdoor_bulb = POK.Appliance(POK,1,13,1,5,v3,5, wd_we_type = 0)   
POK_outdoor_bulb.windows(t_out,t0,0)

POK_outdoor_bulb = POK.Appliance(POK,1,13,1,5,v3,5, wd_we_type = 0)   
POK_outdoor_bulb.windows(t22,t0,0)
...
POK_Phone_charger.windows(t1,t0,0)
...
POK_Laptop_PC_charger.windows(t1,t0,0)
...
POK_bulb_living = POK.Appliance(POK,2,10,1,30,v3,30, wd_we_type = 1)
POK_bulb_living.windows(t11,t0,v1)

POK_bulb_living = POK.Appliance(POK,2,10,2,150,v3,150, wd_we_type = 1)
POK_bulb_living.windows(t22,th,0)

POK_bulb_kitchen = POK.Appliance(POK,1,10,2,100,v3,100, wd_we_type = 1)
...
POK_bulb2_bedroom = POK.Appliance(POK,1,10,1,10,v3,10, wd_we_type = 1)
POK_bulb2_bedroom.windows([1140,1320],t0,0)

POK_bulb_BT_hallway = POK.Appliance(POK,2,10,1,10,0.25,10, wd_we_type = 1)
POK_bulb_BT_hallway.windows(t11,t0,v1)

POK_bulb_BT_hallway = POK.Appliance(POK,2,10,2,20,0.25,10, wd_we_type = 1)
POK_bulb_BT_hallway.windows(t22,th,0)

POK_outdoor_bulb = POK.Appliance(POK,1,13,1,5,v3,5, wd_we_type = 1)   
POK_outdoor_bulb.windows(t_out,t0,0)

POK_outdoor_bulb = POK.Appliance(POK,1,13,2,10,v3,10, wd_we_type = 1)  
POK_outdoor_bulb.windows(t22,th,0)
...
PMK_bulb_living = PMK.Appliance(PMK,3,10,1,30,v3,30, wd_we_type = 0)
PMK_bulb_living.windows(t1,t0,v1)

PMK_bulb_living = PMK.Appliance(PMK,3,10,1,150,v3,150, wd_we_type = 0)
PMK_bulb_living.windows(t22,t0,0)

PMK_bulb_kitchen = PMK.Appliance(PMK,1,10,1,30,v3,30, wd_we_type = 0)
PMK_bulb_kitchen.windows(t1,t0,v1)

PMK_bulb_kitchen = PMK.Appliance(PMK,1,10,1,70,v3,70, wd_we_type = 0)
...
PMK_bulb3_bedroom = PMK.Appliance(PMK,1,10,1,30,v3,30, wd_we_type = 0)
PMK_bulb3_bedroom.windows(t1,t0,v1)

PMK_bulb3_bedroom = PMK.Appliance(PMK,1,10,1,30,v3,30, wd_we_type = 0)
PMK_bulb3_bedroom.windows(t2,t0,v1)

PMK_bulb_BT_hallway = PMK.Appliance(PMK,2,10,1,10,0.25,10, wd_we_type = 0)
PMK_bulb_BT_hallway.windows(t1,t0,v1)

PMK_bulb_BT_hallway = PMK.Appliance(PMK,2,10,1,20,0.25,10, wd_we_type = 0)
PMK_bulb_BT_hallway.windows(t22,t0,0)

PMK_outdoor_bulb = PMK.Appliance(PMK,2,13,1,5,v3,5, wd_we_type = 0)   
PMK_outdoor_bulb.windows(t_out,t0,0)

PMK_outdoor_bulb = PMK.Appliance(PMK,2,13,1,5,v3,5, wd_we_type = 0)   
PMK_outdoor_bulb.windows(t22,t0,0)
...
PMK_Phone_charger.windows(t1,t0,0)
...
PMK_Laptop_PC_charger.windows(t1,t0,0)
...
PMK_bulb_living = PMK.Appliance(PMK,3,10,1,30,v3,30, wd_we_type = 1)
PMK_bulb_living.windows(t11,t0,v1)

PMK_bulb_living = PMK.Appliance(PMK,3,10,2,150,v3,150, wd_we_type = 1)
PMK_bulb_living.windows(t22,th,0)

PMK_bulb_kitchen = PMK.Appliance(PMK,1,10,2,100,v3,100, wd_we_type = 1)
...
PMK_bulb2_bedroom = PMK.Appliance(PMK,1,10,1,30,v3,30, wd_we_type = 1)
PMK_bulb2_bedroom.windows([1140,1320],t0,0)

PMK_bulb2_bedroom = PMK.Appliance(PMK,1,10,2,30,v3,30, wd_we_type = 1)
PMK_bulb2_bedroom.windows(t2,th,v1)

PMK_bulb_BT_hallway = PMK.Appliance(PMK,2,10,1,10,0.25,10, wd_we_type = 1)
PMK_bulb_BT_hallway.windows(t11,t0,v1)

PMK_bulb_BT_hallway = PMK.Appliance(PMK,2,10,2,20,0.25,10, wd_we_type = 1)
PMK_bulb_BT_hallway.windows(t22,th,0)

PMK_outdoor_bulb = PMK.Appliance(PMK,1,13,1,5,v3,5, wd_we_type = 1)   
PMK_outdoor_bulb.windows(t_out,t0,0)

PMK_outdoor_bulb = PMK.Appliance(PMK,1,13,2,15,v3,15, wd_we_type = 1)  
PMK_outdoor_bulb.windows(t22,th,0)
