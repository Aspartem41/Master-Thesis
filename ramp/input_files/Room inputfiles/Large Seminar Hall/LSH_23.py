...
LSH = Room("Large Seminar Hall",N,RP)
Room_list.append(LSH)

df = pd.read_excel('input_files/Room inputfiles/Large Seminar Hall/Large Seminar Hall.xlsx', sheet_name = 'SS_Summer' , index_col=0)
...
# Lights - Weekdays
LSH_Lights = LSH.Appliance(LSH,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.8)
LSH_Lights.windows(t1,t0,v0)

# Lights - Weekend
LSH_Lights = LSH.Appliance(LSH,nl,l_ap,ntf,l_ft_we,v0,l_mt_we, wd_we_type = 1, occasional_use = 0.2)
LSH_Lights.windows(t1,t0,v0)
...
# Projector - Weekdays
LSH_projector = LSH.Appliance(LSH,nprj,prj_ap,ntf,prj_ft_wd,v0,prj_mt_wd, wd_we_type = 0, occasional_use = 0.8)
LSH_projector.windows(t1,t0,v0)

# Projector - Weekend
LSH_projector = LSH.Appliance(LSH,nprj,prj_ap,ntf,prj_ft_we,v0,prj_mt_we, wd_we_type = 1, occasional_use = 0.2)
LSH_projector.windows(t1,t0,v0)
...
# Laptop - Weekdays
LSH_Lap = LSH.Appliance(LSH,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
LSH_Lap.windows(t1,t0,v0)
LSH_Lap.specific_cycle_1(lap_ap,lap_apt_wd,lap_sp,lap_spt_wd,v1)
LSH_Lap.cycle_behaviour(t1,t0)

# Laptop - Weekend
LSH_Lap = LSH.Appliance(LSH,nlap,lap_ap,ntf,lap_ft_we,v0,lap_mt_we, fixed_cycle = 1, wd_we_type = 1, occasional_use = 0.2)
LSH_Lap.windows(t1,t0,v0)
LSH_Lap.specific_cycle_1(lap_ap,lap_apt_we,lap_sp,lap_spt_we,v1)
LSH_Lap.cycle_behaviour(t1,t0)
...
# Mobile - Weekdays
LSH_Mobile = LSH.Appliance(LSH,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.8)
LSH_Mobile.windows(t1,t0,v0)

# Mobile - Weekend
LSH_Mobile = LSH.Appliance(LSH,nmob,mob_ap,ntf,mob_ft_we,v0,mob_mt_we, wd_we_type = 1, occasional_use = 0.2)
LSH_Mobile.windows(t1,t0,v0)
