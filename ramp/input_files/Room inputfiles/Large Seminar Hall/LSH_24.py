...
df = pd.read_excel('input_files/Room inputfiles/Large Seminar Hall/Large Seminar Hall.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
LSH_Lights = LSH.Appliance(LSH,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.6)
...
# Laptop - Weekdays
LSH_Lap = LSH.Appliance(LSH,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.6)
...
# Mobile - Weekdays
LSH_Mobile = LSH.Appliance(LSH,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.6)
