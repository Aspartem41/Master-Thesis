...
df = pd.read_excel('input_files/Room inputfiles/Computer Lab/Computer Lab.xlsx', sheet_name = 'SS_Break' , index_col=0)
...
# Lights - Weekdays
ITLAB_Lights = ITLAB.Appliance(ITLAB,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, wd_we_type = 0, occasional_use = 0.2)
...
# Projector - Weekdays
ITLAB_projector = ITLAB.Appliance(ITLAB,nprj,prj_ap,ntf,prj_ft_wd,v1,prj_mt_wd, wd_we_type = 0, occasional_use = 0.2)
...
# Computer - Weekdays
ITLAB_Comp = ITLAB.Appliance(ITLAB,ncomp,comp_ap,ntf,comp_ft_wd,v1,comp_mt_wd, wd_we_type = 0, occasional_use = 0.2)
...
# Monitor - Weekdays
ITLAB_Moni = ITLAB.Appliance(ITLAB,nmon,mon_ap,ntf,mon_ft_wd,v1,mon_mt_wd, wd_we_type = 0, occasional_use = 0.2)
...
# Laptop - Weekdays
ITLAB_Lap = ITLAB.Appliance(ITLAB,nlap,lap_ap,ntf,lap_ft_wd,v1,lap_mt_wd, wd_we_type = 0, occasional_use = 0.2)
...
# Mobile - Weekdays
ITLAB_Mobile = ITLAB.Appliance(ITLAB,nmob,mob_ap,ntf,mob_ft_wd,v1,mob_mt_wd, wd_we_type = 0, occasional_use = 0.2)
