...
df = pd.read_excel('input_files/Room inputfiles/Medium Seminar Hall/Medium Seminar Hall.xlsx', sheet_name = 'SS_Summer' , index_col=0)
...
# Lights - Weekdays
MSH_Lights = MSH.Appliance(MSH,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.8)
...
# Laptop - Weekdays
MSH_Lap = MSH.Appliance(MSH,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
...
# Mobile - Weekdays
MSH_Mobile = MSH.Appliance(MSH,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.8)
