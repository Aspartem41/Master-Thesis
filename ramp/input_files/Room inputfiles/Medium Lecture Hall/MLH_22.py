...
df = pd.read_excel('input_files/Room inputfiles/Medium Lecture Hall/Medium Lecture Hall.xlsx', sheet_name = 'SS_Spring' , index_col=0)
...
# Lights - Weekdays
MLH_Lights = MLH.Appliance(MLH,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.8)
...
# Projector - Weekdays
MLH_projector = MLH.Appliance(MLH,nprj,prj_ap,ntf,prj_ft_wd,v0,prj_mt_wd, wd_we_type = 0, occasional_use = 0.8)
...
# Computer - Weekdays
MLH_Comp = MLH.Appliance(MLH,ncomp,comp_ap,ntf,comp_ft_wd,v0,comp_mt_wd, wd_we_type = 0, occasional_use = 0.8)
...
# Monitor - Weekdays
MLH_Moni = MLH.Appliance(MLH,nmon,mon_ap,ntf,mon_ft_wd,v0,mon_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
...
# Laptop - Weekdays
MLH_Lap = MLH.Appliance(MLH,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
...
# Mobile - Weekdays
MLH_Mobile = MLH.Appliance(MLH,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.8)
