...
df = pd.read_excel('input_files/Room inputfiles/Storage Room/Storage Room.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
STR_Lights = STR.Appliance(STR,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 0.8)
