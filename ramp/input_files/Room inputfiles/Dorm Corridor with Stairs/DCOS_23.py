...
df = pd.read_excel('input_files/Room inputfiles/Dorm Corridor with Stairs/Dorm Corridor with Stairs.xlsx', sheet_name = 'SS_Summer' , index_col=0)

# Timeframes
ntf = 2           # Number of timeframes used
t0 = [0,0] 
t1 = [0,420]       # 00:00 AM - 07:00 AM
t2 = [1140,1440]   # 07:00 PM - 00:00 AM
