...
HPL = Room("High Power Lab",N,RP)
Room_list.append(HPL)

df = pd.read_excel('input_files/Room inputfiles/High Power Lab/High Power Lab.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
HPL_Lights = HPL.Appliance(HPL,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
HPL_Lights.windows(t1,t0,v0)

#LIghts - Weekend
HPL_Lights = HPL.Appliance(HPL,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, fixed = 'yes', wd_we_type = 1, occasional_use = 0.2)
HPL_Lights.windows(t1,t0,v0)
