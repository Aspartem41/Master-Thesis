# -*- coding: utf-8 -*-
"""
Created on Mon Apr 15 15:38:05 2024
...
KI5 = Room("Kitchen 5P",N,RP)
Room_list.append(KI5)

df = pd.read_excel('input_files/Room inputfiles/Kitchen 5P/Kitchen 5P.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Light - Alldays
KI5_Light = KI5.Appliance(KI5,nl,l_ap,ntf2,l_ft1,v2,l_mt1, fixed = 'yes', wd_we_type = 2, occasional_use = 0.85)
KI5_Light.windows(t1,t2,v0,t3,t4)
...
# Stove - Alldays
KI5_Stove = KI5.Appliance(KI5,nstv,stv_ap,ntf1,stv_ft2,v1,stv_mt2, fixed_cycle = 1, wd_we_type = 2, occasional_use = 0.5)
KI5_Stove.windows(t1,t0,v0)
KI5_Stove.specific_cycle_1(stv_ap,stv_spt1,stv_sp,stv_spt2,v1)
KI5_Stove.cycle_behaviour(t1,t0)

KI5_Stove = KI5.Appliance(KI5,nstv,stv_ap,ntf1,stv_ft1,v1,stv_mt1, fixed_cycle = 1, wd_we_type = 2, occasional_use = 0.65)
KI5_Stove.windows(t2,t0,v0)
KI5_Stove.specific_cycle_1(stv_ap,stv_apt,stv_sp,stv_spt3,v1)
KI5_Stove.cycle_behaviour(t2,t0)

KI5_Stove = KI5.Appliance(KI5,nstv,stv_ap,ntf1,stv_ft2,v1,stv_mt2, fixed_cycle = 1, wd_we_type = 2, occasional_use = 0.2)
KI5_Stove.windows(t3,t0,v0)
KI5_Stove.specific_cycle_1(stv_ap,stv_spt1,stv_sp,stv_spt2,v1)
KI5_Stove.cycle_behaviour(t3,t0)

KI5_Stove = KI5.Appliance(KI5,nstv,stv_ap,ntf1,stv_ft1,v1,stv_mt1, fixed_cycle = 1, wd_we_type = 2, occasional_use = 0.65)
KI5_Stove.windows(t4,t0,v0)
KI5_Stove.specific_cycle_1(stv_ap,stv_apt,stv_sp,stv_spt3,v1)
KI5_Stove.cycle_behaviour(t4,t0)
...
# Fridge - Alldays
KI5_Fridge = KI5.Appliance(KI5,nrfg,rfg_ap,ntf1,rfg_ft1,v1,rfg_mt1, fixed_cycle = 3, wd_we_type = 2, occasional_use = 1)
KI5_Fridge.windows(t5,t0,v0)
KI5_Fridge.specific_cycle_1(rfg_ap,rfg_spt3,rfg_sp,rfg_spt1)
KI5_Fridge.specific_cycle_2(rfg_ap,rfg_spt2,rfg_sp,rfg_spt2)
KI5_Fridge.specific_cycle_3(rfg_ap,rfg_spt1,rfg_sp,rfg_spt3)
KI5_Fridge.cycle_behaviour(trf1,t0,trf2,t0,trf3,trf4)
...
# Microwave - Alldays
KI5_Microwave = KI5.Appliance(KI5,nmicw,micw_ap,ntf2,micw_ft1,v1,micw_mt1, wd_we_type = 2, occasional_use = 0.5)
KI5_Microwave.windows(t1,t2,v0,t3,t4)
...
# Toaster - Alldays
KI5_Toaster = KI5.Appliance(KI5,ntstr,tstr_ap,ntf2,tstr_ft1,v1,tstr_mt1, wd_we_type = 2, occasional_use = 0.2)
KI5_Toaster.windows(t1,t2,v0,t3,t4)
...
# Oven - Alldays
KI5_Oven = KI5.Appliance(KI5,novn,ovn_ap,ntf2,ovn_ft1,v1,ovn_mt1, wd_we_type = 2, occasional_use = 0.5)
KI5_Oven.windows(t1,t2,v0,t3,t4)
...
# Mixer - Alldays
KI5_Mixer = KI5.Appliance(KI5,nmxr,mxr_ap,ntf2,mxr_ft1,v1,mxr_mt1, wd_we_type = 2, occasional_use = 0.2)
KI5_Mixer.windows(t1,t2,v0,t3,t4)
