...
df = pd.read_excel('input_files/Room inputfiles/Hike Lab/Hike Lab.xlsx', sheet_name = 'WS_Winter' , index_col=0)
...
# Lights - Weekdays
HKL_Lights = HKL.Appliance(HKL,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
...
# Hydroponic - Everyday
HKL_Hydroponic = HKL.Appliance(HKL,nhydp,hydp_ap,ntf,hydp_ft_wd,v0,hydp_mt_wd, fixed_cycle = 1, wd_we_type = 3, occasional_use = 0.8)
HKL_Hydroponic.windows(t2,t0,v0)
HKL_Hydroponic.specific_cycle_1(hydp_ap,hydp_apt_wd,hydp_sp,hydp_spt_wd,v1)
HKL_Hydroponic.cycle_behaviour(t2,t0)
