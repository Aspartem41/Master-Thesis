...
df = pd.read_excel('input_files/Room inputfiles/Workshop/Workshop.xlsx', sheet_name = 'WS_Autumn' , index_col=0)
...
# Lights - Weekdays
WKS_Lights = WKS.Appliance(WKS,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
