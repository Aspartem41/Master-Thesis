...
# Lights - Weekdays
SWC_Lights = SWC.Appliance(SWC,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, wd_we_type = 0, occasional_use = 1)
SWC_Lights.windows(t1,t0,v0)

# Lights - Weekend
# SWC_Lights = SWC.Appliance(SWC,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, wd_we_type = 1, occasional_use = 0.5)
# SWC_Lights.windows(t1,t0,v0)
