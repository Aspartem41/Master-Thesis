# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 08:55:27 2024
...
BMTR = Room("Big Meeting Room",N,RP)
Room_list.append(BMTR)

df = pd.read_excel('input_files/Room inputfiles/Big Meeting Room/Big Meeting Room.xlsx', sheet_name = 'SS_Spring' , index_col=0)
...
# Lights - Weekdays
BMTR_Lights = BMTR.Appliance(BMTR,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.8)
BMTR_Lights.windows(t1,t0,v0)

#LIghts - Weekend
BMTR_Lights = BMTR.Appliance(BMTR,nl,l_ap,ntf,l_ft_we,v0,l_mt_we, wd_we_type = 1, occasional_use = 0.2)
BMTR_Lights.windows(t1,t0,v0)
...
# Projector - Weekdays
BMTR_projector = BMTR.Appliance(BMTR,nprj,prj_ap,ntf,prj_ft_wd,v0,prj_mt_wd, wd_we_type = 0, occasional_use = 0.8)
BMTR_projector.windows(t1,t0,v0)

# Projector - Weekend
BMTR_projector = BMTR.Appliance(BMTR,nprj,prj_ap,ntf,prj_ft_we,v0,prj_mt_we, wd_we_type = 1, occasional_use = 0.2)
BMTR_projector.windows(t1,t0,v0)
...
# Computer - Weekdays
BMTR_Comp = BMTR.Appliance(BMTR,ncomp,comp_ap,ntf,comp_ft_wd,v0,comp_mt_wd, wd_we_type = 0, occasional_use = 0.8)
BMTR_Comp.windows(t1,t0,v0)
BMTR_Comp.specific_cycle_1(comp_ap,comp_apt_wd,comp_sp,comp_spt_wd,v1)
BMTR_Comp.cycle_behaviour(t1,t0)

# Computer - Weekend
BMTR_Comp = BMTR.Appliance(BMTR,ncomp,comp_ap,ntf,comp_ft_we,v0,comp_mt_we, wd_we_type = 1, occasional_use = 0.2)
BMTR_Comp.windows(t1,t0,v0)
BMTR_Comp.specific_cycle_1(comp_ap,comp_apt_we,comp_sp,comp_spt_we,v1)
BMTR_Comp.cycle_behaviour(t1,t0)
...
# Monitor - Weekdays
BMTR_Moni = BMTR.Appliance(BMTR,nmon,mon_ap,ntf,mon_ft_wd,v0,mon_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
BMTR_Moni.windows(t1,t0,v0)
BMTR_Moni.specific_cycle_1(mon_ap,mon_apt_wd,mon_sp,mon_spt_wd,v1)
BMTR_Moni.cycle_behaviour(t1,t0)

# Monitor - Weekend
BMTR_Moni = BMTR.Appliance(BMTR,nmon,mon_ap,ntf,mon_ft_we,v0,mon_mt_we, fixed_cycle = 1, wd_we_type = 1, occasional_use = 0.2)
BMTR_Moni.windows(t1,t0,v0)
BMTR_Moni.specific_cycle_1(mon_ap,mon_apt_we,mon_sp,mon_spt_we,v1)
BMTR_Moni.cycle_behaviour(t1,t0)
...
# Laptop - Weekdays
BMTR_Lap = BMTR.Appliance(BMTR,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
BMTR_Lap.windows(t1,t0,v0)
BMTR_Lap.specific_cycle_1(lap_ap,lap_apt_wd,lap_sp,lap_spt_wd,v1)
BMTR_Lap.cycle_behaviour(t1,t0)

# Laptop - Weekend
BMTR_Lap = BMTR.Appliance(BMTR,nlap,lap_ap,ntf,lap_ft_we,v0,lap_mt_we, fixed_cycle = 1, wd_we_type = 1, occasional_use = 0.2)
BMTR_Lap.windows(t1,t0,v0)
BMTR_Lap.specific_cycle_1(lap_ap,lap_apt_we,lap_sp,lap_spt_we,v1)
BMTR_Lap.cycle_behaviour(t1,t0)
...
# Mobile - Weekdays
BMTR_Mobile = BMTR.Appliance(BMTR,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.8)
BMTR_Mobile.windows(t1,t0,v0)

# Mobile - Weekend
BMTR_Mobile = BMTR.Appliance(BMTR,nmob,mob_ap,ntf,mob_ft_we,v0,mob_mt_we, wd_we_type = 1, occasional_use = 0.2)
BMTR_Mobile.windows(t1,t0,v0)