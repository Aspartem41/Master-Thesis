# -*- coding: utf-8 -*-
"""
Created on Sat Mar 16 11:12:01 2024
...
df = pd.read_excel('input_files/Room inputfiles/Big Meeting Room/Big Meeting Room.xlsx', sheet_name = 'WS_Break' , index_col=0)
...
# Lights - Weekdays
BMTR_Lights = BMTR.Appliance(BMTR,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.4)
...
# Projector - Weekdays
BMTR_projector = BMTR.Appliance(BMTR,nprj,prj_ap,ntf,prj_ft_wd,v0,prj_mt_wd, wd_we_type = 0, occasional_use = 0.4)
...
# Computer - Weekdays
BMTR_Comp = BMTR.Appliance(BMTR,ncomp,comp_ap,ntf,comp_ft_wd,v0,comp_mt_wd, wd_we_type = 0, occasional_use = 0.4)
...
# Monitor - Weekdays
BMTR_Moni = BMTR.Appliance(BMTR,nmon,mon_ap,ntf,mon_ft_wd,v0,mon_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.4)
...
# Laptop - Weekdays
BMTR_Lap = BMTR.Appliance(BMTR,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.4)
...
# Mobile - Weekdays
BMTR_Mobile = BMTR.Appliance(BMTR,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.4)
