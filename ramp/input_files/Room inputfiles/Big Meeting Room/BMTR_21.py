# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 08:51:14 2024
...
df = pd.read_excel('input_files/Room inputfiles/Big Meeting Room/Big Meeting Room.xlsx', sheet_name = 'SS_Break' , index_col=0)
