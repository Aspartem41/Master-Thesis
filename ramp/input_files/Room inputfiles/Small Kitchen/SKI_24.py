...
SKI = Room("Small Kitchen",N,RP)
Room_list.append(SKI)

df = pd.read_excel('input_files/Room inputfiles/Small Kitchen/Small Kitchen.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
SKI_Lights = SKI.Appliance(SKI,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
SKI_Lights.windows(t1,t0,v0)

#LIghts - Weekend
SKI_Lights = SKI.Appliance(SKI,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, fixed = 'yes', wd_we_type = 1, occasional_use = 0.2)
SKI_Lights.windows(t1,t0,v0)
