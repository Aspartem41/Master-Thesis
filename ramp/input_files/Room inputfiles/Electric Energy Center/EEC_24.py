...
EEC = Room("Electric Energy Center",N,RP)
Room_list.append(EEC)

df = pd.read_excel('input_files/Room inputfiles/Electric Energy Center/Electric Energy Center.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
EEC_Lights = EEC.Appliance(EEC,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
EEC_Lights.windows(t1,t0,v0)

#LIghts - Weekend
EEC_Lights = EEC.Appliance(EEC,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, fixed = 'yes', wd_we_type = 1, occasional_use = 0.2)
EEC_Lights.windows(t1,t0,v0)
