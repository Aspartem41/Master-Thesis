...
df = pd.read_excel('input_files/Room inputfiles/Thermal Lab/Thermal Lab.xlsx', sheet_name = 'WS_Winter' , index_col=0)
...
# # Basic Load - Weekdays
# THLAB_Basic = THLAB.Appliance(THLAB,nbl,bl_ap,ntf,bl_ft_wd,v1,bl_mt_wd, wd_we_type = 0, occasional_use = 0.2)
