...
THLAB = Room("Thermal Lab",N,RP)
Room_list.append(THLAB)

df = pd.read_excel('input_files/Room inputfiles/Thermal Lab/Thermal Lab.xlsx', sheet_name = 'SS_Summer' , index_col=0)
...
# Lights - Weekdays
THLAB_Lights = THLAB.Appliance(THLAB,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, wd_we_type = 0, occasional_use = 0.2)
THLAB_Lights.windows(t1,t0,v0)

# Lights - Weekend
# THLAB_Lights = THLAB.Appliance(THLAB,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, wd_we_type = 1, occasional_use = 0.2)
# THLAB_Lights.windows(t1,t0,v0)
...
# Computer - Weekdays
THLAB_Comp = THLAB.Appliance(THLAB,ncomp,comp_ap,ntf,comp_ft_wd,v1,comp_mt_wd, wd_we_type = 0, occasional_use = 0.2)
THLAB_Comp.windows(t1,t0,v0)

# Computer - Weekend
# THLAB_Comp = THLAB.Appliance(THLAB,ncomp,comp_ap,ntf,comp_ft_we,v1,comp_mt_we, wd_we_type = 1, occasional_use = 0.2)
# THLAB_Comp.windows(t1,t0,v0)
...
# Monitor - Weekdays
THLAB_Moni = THLAB.Appliance(THLAB,nmon,mon_ap,ntf,mon_ft_wd,v1,mon_mt_wd, wd_we_type = 0, occasional_use = 0.2)
THLAB_Moni.windows(t1,t0,v0)

# Monitor - Weekend
# THLAB_Moni = THLAB.Appliance(THLAB,nmon,mon_ap,ntf,mon_ft_we,v1,mon_mt_we, wd_we_type = 1, occasional_use = 0.2)
# THLAB_Moni.windows(t1,t0,v0)
...
# # Basic Load - Weekdays
# THLAB_Basic = THLAB.Appliance(THLAB,nbl,bl_ap,ntf,bl_ft_wd,v1,bl_mt_wd, wd_we_type = 0, occasional_use = 0.4)
# THLAB_Basic.windows(t1,t0,v0)

# # Basic Load - Weekend
# # THLAB_Basic = THLAB.Appliance(THLAB,nbl,bl_ap,ntf,bl_ft_we,v1,bl_mt_we, wd_we_type = 1, occasional_use = 0.2)
# # THLAB_Basic.windows(t1,t0,v0)
...
THLAB_Experiment_1 = THLAB.Appliance(THLAB,nex1,ex1_ap,ntf,ex1_ft_wd,v1,ex1_mt_wd, wd_we_type = 0, occasional_use = 0.2)
THLAB_Experiment_1.windows(t1,t0,v0)

# Experiment_1 - Weekend
# THLAB_Experiment_1 = THLAB.Appliance(THLAB,nex1,ex1_ap,ntf,ex1_ft_we,v1,ex1_mt_we, wd_we_type = 1, occasional_use = 0.2)
# THLAB_Experiment_1.windows(t1,t0,v0)
...
# THLAB_Experiment_2 = THLAB.Appliance(THLAB,nex2,ex2_ap,ntf,ex2_ft_wd,v1,ex2_mt_wd, wd_we_type = 0, occasional_use = 0.2)
# THLAB_Experiment_2.windows(t1,t0,v0)

# # Experiment_2 - Weekend
# # THLAB_Experiment_2 = THLAB.Appliance(THLAB,nex2,ex2_ap,ntf,ex2_ft_we,v1,ex2_mt_we, wd_we_type = 1, occasional_use = 0.2)
# # THLAB_Experiment_2.windows(t1,t0,v0)
...
# # Project - Weekdays
# THLAB_Project = THLAB.Appliance(THLAB,npro,pro_ap,ntf,pro_ft_wd,v1,pro_mt_wd, wd_we_type = 0, occasional_use = 0.2)
# THLAB_Project.windows(t1,t0,v0)

# # Project - Weekend
# # THLAB_Project = THLAB.Appliance(THLAB,npro,pro_ap,ntf,pro_ft_we,v1,pro_mt_we, wd_we_type = 1, occasional_use = 0.2)
# # THLAB_Project.windows(t1,t0,v0)