...
MWK = Room("Mechanical Workshop",N,RP)
Room_list.append(MWK)

df = pd.read_excel('input_files/Room inputfiles/Mechanical Workshop/Mechanical Workshop.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
MWK_Lights = MWK.Appliance(MWK,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
MWK_Lights.windows(t1,t0,v0)

#LIghts - Weekend
MWK_Lights = MWK.Appliance(MWK,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, fixed = 'yes', wd_we_type = 1, occasional_use = 0.2)
MWK_Lights.windows(t1,t0,v0)
