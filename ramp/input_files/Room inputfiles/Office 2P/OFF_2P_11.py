# -*- coding: utf-8 -*-
"""
Created on Sat Mar 23 10:46:01 2024
...
# devices = ['Light', 'Computer', 'Monitor', 'Laptop' , 'Printer', 'Mobile', 'Lamp']

# for device in devices:
#     for parameter in ['Number' , 'AP (W)', 'APT-WD (mins)' , 'APT-WE (mins)', 'SP (W)' , 'SPT-WD (mins)' , 'SPT-WE (mins)', 'TT-WD (mins)' , 'TT-WE (mins)' , 'MT-WD (mins)' , 'MT-WE (mins)']:
#         globals()[f'{device}_{parameter}'] = df.loc[device, parameter]

# OFF_2P_Lights = OFF_2P.Appliance(OFF_2P,Light_Number,12,2,545,v0,67, wd_we_type = 0, occasional_use = 0.6)
...
# Lights - Weekdays
OFF_2P_Lights = OFF_2P.Appliance(OFF_2P,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.8)
OFF_2P_Lights.windows(t1,t0,v0)
...
# Computer - Weekdays
OFF_2P_Comp = OFF_2P.Appliance(OFF_2P,ncomp,comp_ap,ntf,comp_ft_wd,v0,comp_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
...
# Monitor - Weekdays
OFF_2P_Moni = OFF_2P.Appliance(OFF_2P,nmon,mon_ap,ntf,mon_ft_wd,v0,mon_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
...
# Laptop - Weekdays
OFF_2P_Lap = OFF_2P.Appliance(OFF_2P,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
...
# Printer - Weekdays
OFF_2P_Printer = OFF_2P.Appliance(OFF_2P,nprt,prt_ap,ntf,prt_ft_wd,v0,prt_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
...
# Mobile - Weekdays
OFF_2P_Mobile = OFF_2P.Appliance(OFF_2P,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.8)
...
# Lamp - Weekdays
OFF_2P_Lamp = OFF_2P.Appliance(OFF_2P,nlmp,lmp_ap,ntf,lmp_ft_wd,v0,lmp_mt_wd, wd_we_type = 0, occasional_use = 0.2)
