# -*- coding: utf-8 -*-
"""
Created on Fri Mar  8 10:49:58 2024
...
SSH = Room("Small Seminar Hall",N,RP)
Room_list.append(SSH)

df = pd.read_excel('input_files/Room inputfiles/Small Seminar Hall/Small Seminar Hall.xlsx', sheet_name = 'SS_Spring' , index_col=0)
...
# Lights - Weekdays
SSH_Lights = SSH.Appliance(SSH,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.8)
SSH_Lights.windows(t1,t0,v0)

# Lights - Weekend
SSH_Lights = SSH.Appliance(SSH,nl,l_ap,ntf,l_ft_we,v0,l_mt_we, wd_we_type = 1, occasional_use = 0.2)
SSH_Lights.windows(t1,t0,v0)
...
# Projector - Weekdays
SSH_projector = SSH.Appliance(SSH,nprj,prj_ap,ntf,prj_ft_wd,v0,prj_mt_wd, wd_we_type = 0, occasional_use = 0.8)
SSH_projector.windows(t1,t0,v0)

# Projector - Weekend
SSH_projector = SSH.Appliance(SSH,nprj,prj_ap,ntf,prj_ft_we,v0,prj_mt_we, wd_we_type = 1, occasional_use = 0.2)
SSH_projector.windows(t1,t0,v0)
...
# Laptop - Weekdays
SSH_Lap = SSH.Appliance(SSH,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
SSH_Lap.windows(t1,t0,v0)
SSH_Lap.specific_cycle_1(lap_ap,lap_apt_wd,lap_sp,lap_spt_wd,v1)
SSH_Lap.cycle_behaviour(t1,t0)

# Laptop - Weekend
SSH_Lap = SSH.Appliance(SSH,nlap,lap_ap,ntf,lap_ft_we,v0,lap_mt_we, fixed_cycle = 1, wd_we_type = 1, occasional_use = 0.2)
SSH_Lap.windows(t1,t0,v0)
SSH_Lap.specific_cycle_1(lap_ap,lap_apt_we,lap_sp,lap_spt_we,v1)
SSH_Lap.cycle_behaviour(t1,t0)
...
# Mobile - Weekdays
SSH_Mobile = SSH.Appliance(SSH,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.8)
SSH_Mobile.windows(t1,t0,v0)

# Mobile - Weekend
SSH_Mobile = SSH.Appliance(SSH,nmob,mob_ap,ntf,mob_ft_we,v0,mob_mt_we, wd_we_type = 1, occasional_use = 0.2)
SSH_Mobile.windows(t1,t0,v0)
