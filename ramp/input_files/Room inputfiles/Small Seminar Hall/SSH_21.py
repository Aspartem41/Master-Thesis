# -*- coding: utf-8 -*-
"""
Created on Fri Mar  8 10:53:15 2024
...
df = pd.read_excel('input_files/Room inputfiles/Small Seminar Hall/Small Seminar Hall.xlsx', sheet_name = 'SS_Break' , index_col=0)
