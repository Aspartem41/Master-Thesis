# -*- coding: utf-8 -*-
"""
Created on Wed Feb 28 13:59:12 2024
...
df = pd.read_excel('input_files/Room inputfiles/Small Seminar Hall/Small Seminar Hall.xlsx', sheet_name = 'WS_Break' , index_col=0)
...
# Lights - Weekdays
SSH_Lights = SSH.Appliance(SSH,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.4)
...
# Projector - Weekdays
SSH_projector = SSH.Appliance(SSH,nprj,prj_ap,ntf,prj_ft_wd,v0,prj_mt_wd, wd_we_type = 0, occasional_use = 0.4)
...
# Laptop - Weekdays
SSH_Lap = SSH.Appliance(SSH,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.4)
...
# Mobile - Weekdays
SSH_Mobile = SSH.Appliance(SSH,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.4)
