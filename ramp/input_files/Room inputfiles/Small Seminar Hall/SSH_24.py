# -*- coding: utf-8 -*-
"""
Created on Fri Mar  8 11:08:12 2024
...
df = pd.read_excel('input_files/Room inputfiles/Small Seminar Hall/Small Seminar Hall.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
SSH_Lights = SSH.Appliance(SSH,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.6)
...
# Laptop - Weekdays
SSH_Lap = SSH.Appliance(SSH,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.6)
...
# Mobile - Weekdays
SSH_Mobile = SSH.Appliance(SSH,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.6)
