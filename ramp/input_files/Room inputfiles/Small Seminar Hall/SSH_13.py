# -*- coding: utf-8 -*-
"""
Created on Sat Mar  2 10:45:36 2024
...
df = pd.read_excel('input_files/Room inputfiles/Small Seminar Hall/Small Seminar Hall.xlsx', sheet_name = 'WS_Winter' , index_col=0)
