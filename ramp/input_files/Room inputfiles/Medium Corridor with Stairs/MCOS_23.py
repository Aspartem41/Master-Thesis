# -*- coding: utf-8 -*-
"""
Created on Mon Apr 15 18:34:59 2024
...
df = pd.read_excel('input_files/Room inputfiles/Medium Corridor with Stairs/Medium Corridor with Stairs.xlsx', sheet_name = 'SS_Summer' , index_col=0)
