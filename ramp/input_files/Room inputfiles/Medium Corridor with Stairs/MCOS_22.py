# -*- coding: utf-8 -*-
"""
Created on Mon Apr 15 18:32:50 2024
...
MCOS = Room("Medium Corridor with Stairs",N,RP)
Room_list.append(MCOS)

df = pd.read_excel('input_files/Room inputfiles/Medium Corridor with Stairs/Medium Corridor with Stairs.xlsx', sheet_name = 'SS_Spring' , index_col=0)
...
# Lights - Weekdays
MCOS_Lights = MCOS.Appliance(MCOS,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
MCOS_Lights.windows(t1,t0,v0)

#LIghts - Weekend
MCOS_Lights = MCOS.Appliance(MCOS,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, fixed = 'yes', wd_we_type = 1, occasional_use = 0.5)
MCOS_Lights.windows(t1,t0,v0)