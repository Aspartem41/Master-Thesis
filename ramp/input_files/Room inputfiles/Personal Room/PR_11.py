...
df = pd.read_excel('input_files/Room inputfiles/Personal Room/Personal Room.xlsx', sheet_name = 'WS_Break' , index_col=0)
...
# Laptop - Allday
PR_Lap = PR.Appliance(PR,nlap,lap_ap,ntf1,lap_ft_wd,v1,lap_mt_wd, fixed_cycle = 1, wd_we_type = 2, occasional_use = 0.65)
