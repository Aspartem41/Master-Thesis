...
df = pd.read_excel('input_files/Room inputfiles/Personal Room/Personal Room.xlsx', sheet_name = 'SS_Summer' , index_col=0)
...
# Fan - Weekdays
PR_fan = PR.Appliance(PR,nfan,fan_ap,ntf2,fan_ft_wd,v1,fan_mt_wd, wd_we_type = 0, occasional_use = 0.85)
PR_fan.windows(t1,t3,v0)

# Fan - Weekend
PR_fan = PR.Appliance(PR,nfan,fan_ap,ntf1,fan_ft_we,v1,fan_mt_we, wd_we_type = 4, occasional_use = 0.85)
