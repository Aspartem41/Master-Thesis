...
df = pd.read_excel('input_files/Room inputfiles/Personal Room/Personal Room.xlsx', sheet_name = 'SS_Break' , index_col=0)
...
# Light - Allday
PR_Light = PR.Appliance(PR,nl,l_ap,ntf1,l_ft_wd,v1,l_mt_wd, wd_we_type = 2, occasional_use = 0.65)
...
# Fan - Allday
PR_fan = PR.Appliance(PR,nfan,fan_ap,ntf1,fan_ft_wd,v1,fan_mt_wd, wd_we_type = 2, occasional_use = 0.65)
