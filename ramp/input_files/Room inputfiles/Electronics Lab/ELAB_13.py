...
df = pd.read_excel('input_files/Room inputfiles/Electronics Lab/Electronics Lab.xlsx', sheet_name = 'WS_Winter' , index_col=0)
...
ELAB_Experiment_2 = ELAB.Appliance(ELAB,nex2,ex2_ap,ntf,ex2_ft_wd,v1,ex2_mt_wd, wd_we_type = 0, occasional_use = 0.1)
