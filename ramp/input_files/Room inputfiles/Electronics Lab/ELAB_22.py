...
df = pd.read_excel('input_files/Room inputfiles/Electronics Lab/Electronics Lab.xlsx', sheet_name = 'SS_Spring' , index_col=0)
...
# Lights - Weekdays
ELAB_Lights = ELAB.Appliance(ELAB,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, wd_we_type = 0, occasional_use = 0.3)
...
ELAB_Experiment_1 = ELAB.Appliance(ELAB,nex1,ex1_ap,ntf,ex1_ft_wd,v1,ex1_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.2)
ELAB_Experiment_1.windows(t1,t0,v0)
ELAB_Experiment_1.specific_cycle_1(ex1_ap,ex1_apt_wd,ex1_sp,ex1_spt_wd,v1)
ELAB_Experiment_1.cycle_behaviour(t1,t0)

# Experiment_1 - Weekend
# ELAB_Experiment_1 = ELAB.Appliance(ELAB,nex1,ex1_ap,ntf,ex1_ft_we,v1,ex1_mt_we, fixed_cycle = 1, wd_we_type = 1, occasional_use = 0.2)
# ELAB_Experiment_1.windows(t1,t0,v0)
# ELAB_Experiment_1.specific_cycle_1(ex1_ap,ex1_apt_we,ex1_sp,ex1_spt_we,v1)
# ELAB_Experiment_1.cycle_behaviour(t1,t0)
