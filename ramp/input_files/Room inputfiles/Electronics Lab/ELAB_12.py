...
df = pd.read_excel('input_files/Room inputfiles/Electronics Lab/Electronics Lab.xlsx', sheet_name = 'WS_Autumn' , index_col=0)
...
# # Basic Load - Weekdays
# ELAB_Basic = ELAB.Appliance(ELAB,nbl,bl_ap,ntf,bl_ft_wd,v1,bl_mt_wd, wd_we_type = 0, occasional_use = 0.2)
