...
IC = Room("Information Center",N,RP)
Room_list.append(IC)

df = pd.read_excel('input_files/Room inputfiles/Information Center/Information Center.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
IC_Lights = IC.Appliance(IC,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
IC_Lights.windows(t1,t0,v0)

#LIghts - Weekend
IC_Lights = IC.Appliance(IC,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, fixed = 'yes', wd_we_type = 1, occasional_use = 0.2)
IC_Lights.windows(t1,t0,v0)
