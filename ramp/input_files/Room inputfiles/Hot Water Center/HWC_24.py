...
HWC = Room("Hot Water Center",N,RP)
Room_list.append(HWC)

df = pd.read_excel('input_files/Room inputfiles/Hot Water Center/Hot Water Center.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
HWC_Lights = HWC.Appliance(HWC,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
HWC_Lights.windows(t1,t0,v0)

#LIghts - Weekend
HWC_Lights = HWC.Appliance(HWC,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, fixed = 'yes', wd_we_type = 1, occasional_use = 0.2)
HWC_Lights.windows(t1,t0,v0)
