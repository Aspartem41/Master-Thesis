...
BGL = Room("Biogas Lab",N,RP)
Room_list.append(BGL)

df = pd.read_excel('input_files/Room inputfiles/Biogas Lab/Biogas Lab.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
BGL_Lights = BGL.Appliance(BGL,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
BGL_Lights.windows(t1,t0,v0)

#LIghts - Weekend
BGL_Lights = BGL.Appliance(BGL,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, fixed = 'yes', wd_we_type = 1, occasional_use = 0.2)
BGL_Lights.windows(t1,t0,v0)
