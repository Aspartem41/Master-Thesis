# -*- coding: utf-8 -*-
"""
Created on Fri Mar  8 18:39:18 2024
...
OFF_1P = Room("Office 1P",N,RP)
Room_list.append(OFF_1P)

df = pd.read_excel('input_files/Room inputfiles/Office 1P/Office 1P.xlsx', sheet_name = 'WS_Winter' , index_col=0)
...
# Lights - Weekdays
OFF_1P_Lights = OFF_1P.Appliance(OFF_1P,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.8)
OFF_1P_Lights.windows(t1,t0,v0)

# Lights - Weekend
# OFF_1P_Lights = OFF_1P.Appliance(OFF_1P,nl,ap,2,tt_we,v0,mt_we, wd_we_type = 1)
# OFF_1P_Lights.windows(t1,t0,v0)
...
# Computer - Weekdays
OFF_1P_Comp = OFF_1P.Appliance(OFF_1P,ncomp,comp_ap,ntf,comp_ft_wd,v0,comp_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
OFF_1P_Comp.windows(t1,t0,v0)
OFF_1P_Comp.specific_cycle_1(comp_ap,comp_apt_wd,comp_sp,comp_spt_wd,v1)
OFF_1P_Comp.cycle_behaviour(t1,t0)

# Computer - Weekend
# OFF_1P_Comp = OFF_1P.Appliance(OFF_1P,ncomp,comp_ap,ntf,comp_ft_we,v0,comp_mt_we, wd_we_type = 1, occasional_use = 0.6)
# OFF_1P_Comp.windows(t1,t0,v0)
# OFF_1P_Comp.specific_cycle_1(comp_ap,comp_apt_we,comp_sp,comp_spt_we,v1)
# OFF_1P_Comp.cycle_behaviour(t1,t0)
...
# Monitor - Weekdays
OFF_1P_Moni = OFF_1P.Appliance(OFF_1P,nmon,mon_ap,ntf,mon_ft_wd,v0,mon_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
OFF_1P_Moni.windows(t1,t0,v0)
OFF_1P_Moni.specific_cycle_1(mon_ap,mon_apt_wd,mon_sp,mon_spt_wd,v1)
OFF_1P_Moni.cycle_behaviour(t1,t0)

# Monitor - Weekend
# OFF_1P_Moni = OFF_1P.Appliance(OFF_1P,nmon,mon_ap,ntf,mon_ft_we,v0,mon_mt_we, fixed_cycle = 1, wd_we_type = 1, occasional_use = 0.6)
# OFF_1P_Moni.windows(t1,t0,v0)
# OFF_1P_Moni.specific_cycle_1(mon_ap,mon_apt_we,mon_sp,mon_spt_we,v1)
# OFF_1P_Moni.cycle_behaviour(t1,t0)
...
# Laptop - Weekdays
OFF_1P_Lap = OFF_1P.Appliance(OFF_1P,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
OFF_1P_Lap.windows(t1,t0,v0)
OFF_1P_Lap.specific_cycle_1(lap_ap,lap_apt_wd,lap_sp,lap_spt_wd,v1)
OFF_1P_Lap.cycle_behaviour(t1,t0)

# Laptop - Weekend
# OFF_1P_Lap = OFF_1P.Appliance(OFF_1P,nlap,lap_ap,ntf,lap_ft_we,v0,lap_mt_we, fixed_cycle = 1, wd_we_type = 1, occasional_use = 0.6)
# OFF_1P_Lap.windows(t1,t0,v0)
# OFF_1P_Lap.specific_cycle_1(lap_ap,lap_apt_we,lap_sp,lap_spt_we,v1)
# OFF_1P_Lap.cycle_behaviour(t1,t0)
...
# Printer - Weekdays
OFF_1P_Printer = OFF_1P.Appliance(OFF_1P,nprt,prt_ap,ntf,prt_ft_wd,v0,prt_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
OFF_1P_Printer.windows(t1,t0,v0)
OFF_1P_Printer.specific_cycle_1(prt_ap,prt_apt_wd,prt_sp,prt_spt_wd,v1)
OFF_1P_Printer.cycle_behaviour(t1,t0)

# Printer - Weekend
# OFF_1P_Printer = OFF_1P.Appliance(OFF_1P,nprt,prt_ap,ntf,prt_ft_we,v0,prt_mt_we, fixed_cycle = 1, wd_we_type = 1, occasional_use = 0.6)
# OFF_1P_Printer.windows(t1,t0,v0)
# OFF_1P_Printer.specific_cycle_4(prt_ap,prt_apt_we,prt_sp,prt_spt_we,v1)
# OFF_1P_Printer.cycle_behaviour(t1,t0)
...
# Mobile - Weekdays
OFF_1P_Mobile = OFF_1P.Appliance(OFF_1P,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.8)
OFF_1P_Mobile.windows(t1,t0,v0)

# Mobile - Weekend
# OFF_1P_Mobile = OFF_1P.Appliance(OFF_1P,nmob,mob_ap,ntf,mob_ft_we,v0,mob_mt_we, wd_we_type = 1, occasional_use = 0.6)
# OFF_1P_Mobile.windows(t1,t0,v0)
...
# Lamp - Weekdays
OFF_1P_Lamp = OFF_1P.Appliance(OFF_1P,nlmp,lmp_ap,ntf,lmp_ft_wd,v0,lmp_mt_wd, wd_we_type = 0, occasional_use = 0.4)
OFF_1P_Lamp.windows(t3,t0,v0)

# Lamp - Weekend
# OFF_1P_Lamp = OFF_1P.Appliance(OFF_1P,nlmp,lmp_ap,ntf,lmp_ft_we,v0,lmp_mt_we, wd_we_type = 1, occasional_use = 0.2)
# OFF_1P_Lamp.windows(t3,t0,v0)
...
# ----------------------------------------------------------------------------------------------------------------------------------
# 2. Administrative building's Office of 1 Person
# ----------------------------------------------------------------------------------------------------------------------------------
