# -*- coding: utf-8 -*-
"""
Created on Sat Mar  9 18:51:37 2024
...
df = pd.read_excel('input_files/Room inputfiles/Office 1P/Office 1P.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
OFF_1P_Lights = OFF_1P.Appliance(OFF_1P,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.6)
...
# Computer - Weekdays
OFF_1P_Comp = OFF_1P.Appliance(OFF_1P,ncomp,comp_ap,ntf,comp_ft_wd,v0,comp_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.6)
...
# Monitor - Weekdays
OFF_1P_Moni = OFF_1P.Appliance(OFF_1P,nmon,mon_ap,ntf,mon_ft_wd,v0,mon_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.6)
...
# Laptop - Weekdays
OFF_1P_Lap = OFF_1P.Appliance(OFF_1P,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.6)
...
# Printer - Weekdays
OFF_1P_Printer = OFF_1P.Appliance(OFF_1P,nprt,prt_ap,ntf,prt_ft_wd,v0,prt_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.6)
...
# Mobile - Weekdays
OFF_1P_Mobile = OFF_1P.Appliance(OFF_1P,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.6)
