...
EWK = Room("E-Tech Workshop",N,RP)
Room_list.append(EWK)

df = pd.read_excel('input_files/Room inputfiles/E-Tech Workshop/E-Tech Workshop.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
EWK_Lights = EWK.Appliance(EWK,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
EWK_Lights.windows(t1,t0,v0)

#LIghts - Weekend
EWK_Lights = EWK.Appliance(EWK,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, fixed = 'yes', wd_we_type = 1, occasional_use = 0.2)
EWK_Lights.windows(t1,t0,v0)
