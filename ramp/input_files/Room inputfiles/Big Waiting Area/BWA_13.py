...
BWA = Room("Big Waiting Area",N,RP)
Room_list.append(BWA)

df = pd.read_excel('input_files/Room inputfiles/Big Waiting Area/Big Waiting Area.xlsx', sheet_name = 'WS_Winter' , index_col=0)
...
# Lights - Weekdays
BWA_Lights = BWA.Appliance(BWA,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, wd_we_type = 0, occasional_use = 1)
BWA_Lights.windows(t1,t0,v0)

#LIghts - Weekend
BWA_Lights = BWA.Appliance(BWA,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, wd_we_type = 1, occasional_use = 0.2)
BWA_Lights.windows(t1,t0,v0)