...
LWC = Room("Large Toilet",N,RP)
Room_list.append(LWC)

df = pd.read_excel('input_files/Room inputfiles/Large Toilet/Large Toilet.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
LWC_Lights = LWC.Appliance(LWC,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
LWC_Lights.windows(t1,t0,v0)

# Lights - Weekend
LWC_Lights = LWC.Appliance(LWC,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, fixed = 'yes', wd_we_type = 1, occasional_use = 0.2)
LWC_Lights.windows(t1,t0,v0)
