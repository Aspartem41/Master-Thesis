...
GTL = Room("Small Toilet",N,RP)
Room_list.append(GTL)

df = pd.read_excel('input_files/Room inputfiles/Small Toilet/Small Toilet.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
GTL_Lights = GTL.Appliance(GTL,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
GTL_Lights.windows(t1,t0,v0)

#LIghts - Weekend
GTL_Lights = GTL.Appliance(GTL,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, fixed = 'yes', wd_we_type = 1, occasional_use = 0.2)
GTL_Lights.windows(t1,t0,v0)
