...
SWA = Room("Small Waiting Area",N,RP)
Room_list.append(SWA)

df = pd.read_excel('input_files/Room inputfiles/Small Waiting Area/Small Waiting Area.xlsx', sheet_name = 'SS_Summer' , index_col=0)
...
# Lights - Weekdays
SWA_Lights = SWA.Appliance(SWA,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, wd_we_type = 0, occasional_use = 1)
SWA_Lights.windows(t1,t0,v0)

#LIghts - Weekend
SWA_Lights = SWA.Appliance(SWA,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, wd_we_type = 1, occasional_use = 0.2)
SWA_Lights.windows(t1,t0,v0)