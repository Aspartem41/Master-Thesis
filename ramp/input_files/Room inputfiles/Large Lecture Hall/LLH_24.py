...
df = pd.read_excel('input_files/Room inputfiles/Large Lecture Hall/Large Lecture Hall.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
LLH_Lights = LLH.Appliance(LLH,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.6)
...
# Laptop - Weekdays
LLH_Lap = LLH.Appliance(LLH,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.6)
...
# Mobile - Weekdays
LLH_Mobile = LLH.Appliance(LLH,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.6)
