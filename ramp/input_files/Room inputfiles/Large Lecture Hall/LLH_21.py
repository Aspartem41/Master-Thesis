...
df = pd.read_excel('input_files/Room inputfiles/Large Lecture Hall/Large Lecture Hall.xlsx', sheet_name = 'SS_Break' , index_col=0)
...
# Lights - Weekdays
LLH_Lights = LLH.Appliance(LLH,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.4)
...
# Projector - Weekdays
LLH_projector = LLH.Appliance(LLH,nprj,prj_ap,ntf,prj_ft_wd,v0,prj_mt_wd, wd_we_type = 0, occasional_use = 0.4)
...
# Computer - Weekdays
LLH_Comp = LLH.Appliance(LLH,ncomp,comp_ap,ntf,comp_ft_wd,v0,comp_mt_wd, wd_we_type = 0, occasional_use = 0.4)
...
# Monitor - Weekdays
LLH_Moni = LLH.Appliance(LLH,nmon,mon_ap,ntf,mon_ft_wd,v0,mon_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.4)
...
# Laptop - Weekdays
LLH_Lap = LLH.Appliance(LLH,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.4)
...
# Mobile - Weekdays
LLH_Mobile = LLH.Appliance(LLH,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.4)
