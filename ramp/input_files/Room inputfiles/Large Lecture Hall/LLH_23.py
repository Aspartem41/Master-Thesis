...
LLH = Room("Large Lecture Hall",N,RP)
Room_list.append(LLH)

df = pd.read_excel('input_files/Room inputfiles/Large Lecture Hall/Large Lecture Hall.xlsx', sheet_name = 'SS_Summer' , index_col=0)
...
# Lights - Weekdays
LLH_Lights = LLH.Appliance(LLH,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, wd_we_type = 0, occasional_use = 0.8)
LLH_Lights.windows(t1,t0,v0)

# Lights - Weekend
LLH_Lights = LLH.Appliance(LLH,nl,l_ap,ntf,l_ft_we,v0,l_mt_we, wd_we_type = 1, occasional_use = 0.2)
LLH_Lights.windows(t1,t0,v0)
...
# Projector - Weekdays
LLH_projector = LLH.Appliance(LLH,nprj,prj_ap,ntf,prj_ft_wd,v0,prj_mt_wd, wd_we_type = 0, occasional_use = 0.8)
LLH_projector.windows(t1,t0,v0)

# Projector - Weekend
LLH_projector = LLH.Appliance(LLH,nprj,prj_ap,ntf,prj_ft_we,v0,prj_mt_we, wd_we_type = 1, occasional_use = 0.2)
LLH_projector.windows(t1,t0,v0)
...
# Computer - Weekdays
LLH_Comp = LLH.Appliance(LLH,ncomp,comp_ap,ntf,comp_ft_wd,v0,comp_mt_wd, wd_we_type = 0, occasional_use = 0.8)
LLH_Comp.windows(t1,t0,v0)
LLH_Comp.specific_cycle_1(comp_ap,comp_apt_wd,comp_sp,comp_spt_wd,v1)
LLH_Comp.cycle_behaviour(t1,t0)

# Computer - Weekend
LLH_Comp = LLH.Appliance(LLH,ncomp,comp_ap,ntf,comp_ft_we,v0,comp_mt_we, wd_we_type = 1, occasional_use = 0.2)
LLH_Comp.windows(t1,t0,v0)
LLH_Comp.specific_cycle_1(comp_ap,comp_apt_we,comp_sp,comp_spt_we,v1)
LLH_Comp.cycle_behaviour(t1,t0)
...
# Monitor - Weekdays
LLH_Moni = LLH.Appliance(LLH,nmon,mon_ap,ntf,mon_ft_wd,v0,mon_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
LLH_Moni.windows(t1,t0,v0)
LLH_Moni.specific_cycle_1(mon_ap,mon_apt_wd,mon_sp,mon_spt_wd,v1)
LLH_Moni.cycle_behaviour(t1,t0)

# Monitor - Weekend
LLH_Moni = LLH.Appliance(LLH,nmon,mon_ap,ntf,mon_ft_we,v0,mon_mt_we, fixed_cycle = 1, wd_we_type = 1, occasional_use = 0.2)
LLH_Moni.windows(t1,t0,v0)
LLH_Moni.specific_cycle_1(mon_ap,mon_apt_we,mon_sp,mon_spt_we,v1)
LLH_Moni.cycle_behaviour(t1,t0)
...
# Laptop - Weekdays
LLH_Lap = LLH.Appliance(LLH,nlap,lap_ap,ntf,lap_ft_wd,v0,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.8)
LLH_Lap.windows(t1,t0,v0)
LLH_Lap.specific_cycle_1(lap_ap,lap_apt_wd,lap_sp,lap_spt_wd,v1)
LLH_Lap.cycle_behaviour(t1,t0)

# Laptop - Weekend
LLH_Lap = LLH.Appliance(LLH,nlap,lap_ap,ntf,lap_ft_we,v0,lap_mt_we, fixed_cycle = 1, wd_we_type = 1, occasional_use = 0.2)
LLH_Lap.windows(t1,t0,v0)
LLH_Lap.specific_cycle_1(lap_ap,lap_apt_we,lap_sp,lap_spt_we,v1)
LLH_Lap.cycle_behaviour(t1,t0)
...
# Mobile - Weekdays
LLH_Mobile = LLH.Appliance(LLH,nmob,mob_ap,ntf,mob_ft_wd,v0,mob_mt_wd, wd_we_type = 0, occasional_use = 0.8)
LLH_Mobile.windows(t1,t0,v0)

# Mobile - Weekend
LLH_Mobile = LLH.Appliance(LLH,nmob,mob_ap,ntf,mob_ft_we,v0,mob_mt_we, wd_we_type = 1, occasional_use = 0.2)
LLH_Mobile.windows(t1,t0,v0)