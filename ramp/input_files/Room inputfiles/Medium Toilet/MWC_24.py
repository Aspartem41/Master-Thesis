...
MWC = Room("Medium Toilet",N,RP)
Room_list.append(MWC)

df = pd.read_excel('input_files/Room inputfiles/Medium Toilet/Medium Toilet.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
MWC_Lights = MWC.Appliance(MWC,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
MWC_Lights.windows(t1,t0,v0)

# Lights - Weekend
MWC_Lights = MWC.Appliance(MWC,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, fixed = 'yes', wd_we_type = 1, occasional_use = 0.5)
MWC_Lights.windows(t1,t0,v0)
