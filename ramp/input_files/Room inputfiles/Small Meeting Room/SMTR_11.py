...
df = pd.read_excel('input_files/Room inputfiles/Small Meeting Room/Small Meeting Room.xlsx', sheet_name = 'WS_Break' , index_col=0)
...
# Lights - Weekdays
SMTR_Lights = SMTR.Appliance(SMTR,nl,l_ap,ntf,l_ft_wd,v0,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 0.8)
...
# TV - Weekdays
SMTR_TV = SMTR.Appliance(SMTR,ntv,tv_ap,ntf,tv_ft_wd,v0,tv_mt_wd, wd_we_type = 0, occasional_use = 0.6)
...
# Camera - Weekdays
SMTR_Camera = SMTR.Appliance(SMTR,ncmr,cmr_ap,ntf,cmr_ft_wd,v0,cmr_mt_wd, wd_we_type = 0, occasional_use = 0.6)
...
# Laptop - Weekdays
SMTR_Lap = SMTR.Appliance(SMTR,nlap,lap_ap,ntf,lap_ft_wd,v1,lap_mt_wd, fixed_cycle = 1, wd_we_type = 0, occasional_use = 0.6)
