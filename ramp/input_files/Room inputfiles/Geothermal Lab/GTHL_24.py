...
GTHL = Room("Geothermal Lab",N,RP)
Room_list.append(GTHL)

df = pd.read_excel('input_files/Room inputfiles/Geothermal Lab/Geothermal Lab.xlsx', sheet_name = 'SS_Exam' , index_col=0)
...
# Lights - Weekdays
GTHL_Lights = GTHL.Appliance(GTHL,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
GTHL_Lights.windows(t1,t0,v0)

#LIghts - Weekend
GTHL_Lights = GTHL.Appliance(GTHL,nl,l_ap,ntf,l_ft_we,v1,l_mt_we, fixed = 'yes', wd_we_type = 1, occasional_use = 0.2)
GTHL_Lights.windows(t1,t0,v0)
