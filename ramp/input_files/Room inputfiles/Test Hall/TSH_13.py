# -*- coding: utf-8 -*-
"""
Created on tmpu Apr 15 15:35:10 2024
...
df = pd.read_excel('input_files/Room inputfiles/Test Hall/Test Hall.xlsx', sheet_name = 'WS_Winter' , index_col=0)
...
TSH_slth = TSH.Appliance(TSH,nslth,slth_ap,ntf,slth_ft_wd,v1,slth_mt_wd, wd_we_type = 0, occasional_use = 0.4)
...
TSH_tmpui = TSH.Appliance(TSH,ntmpu,tmpu_ap,ntf,tmpu_ft_wd,v1,tmpu_mt_wd, wd_we_type = 0, occasional_use = 0.4)
