...
df = pd.read_excel('input_files/Room inputfiles/Test Hall/Test Hall.xlsx', sheet_name = 'SS_Summer' , index_col=0)
...
# Lights - Weekdays
TSH_Lights = TSH.Appliance(TSH,nl,l_ap,ntf,l_ft_wd,v1,l_mt_wd, fixed = 'yes', wd_we_type = 0, occasional_use = 1)
