# -*- coding: utf-8 -*-
"""
Created on Wed Oct  5 18:39:22 2022
...
'''Input File_3 ist für Übergangszeit Profile''''''Innen&außen licht timechange'''
...
#MPgh-Income
MP_indoor_bulb = MP.Appliance(MP,6,7,2,180,0.2,10)
MP_indoor_bulb.windows([330,420],[1110,1440],0.35)         # 19:30 bis 24UHr

MP_outdoor_bulb = MP.Appliance(MP,2,13,2,600,0.2,10)
MP_outdoor_bulb.windows([0,390],[1110,1440],0.35)
...
PMK_indoor_blub = PMK.Appliance(PMK,5,7,2,180,0.2,10)
PMK_indoor_blub.windows([330,420],[1110,1440],0.35)

PMK_outdoor_bulb = PMK.Appliance(PMK,2,13,2,600,0.2,10)
PMK_outdoor_bulb.windows([0,390],[1110,1440],0.35)
...
#Paar ohne Kind
POK_indoor_bulb = POK.Appliance(POK,3,7,2,180,0.2,10)
POK_indoor_bulb.windows([330,420],[1110,1440],0.35)

POK_outdoor_bulb = POK.Appliance(POK,2,13,2,600,0.2,10)
POK_outdoor_bulb.windows([0,390],[1110,1440],0.35)
...
AE_indoor_bulb = AE.Appliance(AE,2,7,2,180,0.2,10)
AE_indoor_bulb.windows([0,390],[1110,1440],0.35)

AE_outdoor_bulb = AE.Appliance(AE,1,13,2,600,0.2,10)
AE_outdoor_bulb.windows([0,330],[1170,1440],0.35)
...
EP_indoor_bulb = EP.Appliance(EP,2,7,2,180,0.2,10)
EP_indoor_bulb.windows([0,390],[1110,1440],0.35)

EP_outdoor_bulb = EP.Appliance(EP,1,13,2,600,0.2,10)
EP_outdoor_bulb.windows([0,330],[1170,1440],0.35)
...
'TV Zet- 50% mehr + andere zeitfenster'


#Mehrpersonen
MP_indoor_bulb = MP.Appliance(MP,6,7,2,180,0.2,10, wd_we_type = 1)
MP_indoor_bulb.windows([330,420],[1110,1440],0.35)         # 19:30 bis 24UHr
...
PMK_indoor_bulb = PMK.Appliance(PMK,5,7,2,180,0.2,10, wd_we_type = 1)
PMK_indoor_bulb.windows([330,420],[1110,1440],0.35)
...
#Paar ohne Kind
POK_indoor_bulb = POK.Appliance(POK,3,7,2,180,0.2,10, wd_we_type = 1)
POK_indoor_bulb.windows([330,420],[1110,1440],0.35)
...
#Low Income Alleinerziehende
AE_indoor_bulb = AE.Appliance(AE,2,7,2,180,0.2,10, wd_we_type = 1)
AE_indoor_bulb.windows([330,420],[1110,1440],0.35)

AE_outdoor_bulb = AE.Appliance(AE,1,13,2,600,0.2,10, wd_we_type = 1)
AE_outdoor_bulb.windows([0,390],[1110,1440],0.35)
...
EP_indoor_bulb = EP.Appliance(EP,2,7,2,180,0.2,10, wd_we_type = 1)
EP_indoor_bulb.windows([330,420],[1110,1440],0.35)

EP_outdoor_bulb = EP.Appliance(EP,1,13,2,600,0.2,10, wd_we_type = 1)
EP_outdoor_bulb.windows([0,390],[1110,1440],0.35)
