...
#MPgh-Income
MP_indoor_bulb = MP.Appliance(MP,6,7,2,120,0.2,10)
MP_indoor_bulb.windows([1170,1440],[0,30],0.35)         # 19:30 bis 24UHr

MP_outdoor_bulb = MP.Appliance(MP,2,13,2,600,0.2,10)
MP_outdoor_bulb.windows([0,330],[1170,1440],0.35)
...
# MP_HP = MP.Appliance(MP,1,Strom_WP,2,1440,0,30,occational_use = 1, thermal_P_var= 0.2)
# MP_HP.windows([0,1440],[0,0]) 

#Paar mit Kind


PMK_indoor_bulb = PMK.Appliance(PMK,5,7,2,120,0.2,10)
PMK_indoor_bulb.windows([1170,1440],[0,30],0.35)

PMK_outdoor_bulb = PMK.Appliance(PMK,2,13,2,600,0.2,10)
PMK_outdoor_bulb.windows([0,330],[1170,1440],0.35)
...
#Paar ohne Kind
POK_indoor_bulb = POK.Appliance(POK,3,7,2,120,0.2,10)
POK_indoor_bulb.windows([1170,1440],[0,30],0.35)

POK_outdoor_bulb = POK.Appliance(POK,2,13,2,600,0.2,10)
POK_outdoor_bulb.windows([0,330],[1170,1440],0.35)
...
POK_Luftfritteuse = POK.Appliance(POK,1,50,3,30,0.1,15,occasional_use = 0.33)
...
AE_indoor_bulb = AE.Appliance(AE,2,7,2,120,0.2,10)
AE_indoor_bulb.windows([1170,1440],[0,30],0.35)
...
EP_indoor_bulb = EP.Appliance(EP,2,7,2,120,0.2,10)
EP_indoor_bulb.windows([1170,1440],[0,30],0.35)
...
#Mehrpersonen
MP_indoor_bulb = MP.Appliance(MP,6,7,2,120,0.2,10, wd_we_type = 1)
MP_indoor_bulb.windows([1170,1440],[0,30],0.35)         # 19:30 bis 24UHr
...
#Paar mit Kind
PMK_indoor_bulb = PMK.Appliance(PMK,5,7,2,120,0.2,10, wd_we_type = 1)
PMK_indoor_bulb.windows([1170,1440],[0,30],0.35)
...
#Paar ohne Kind
POK_indoor_bulb = POK.Appliance(POK,3,7,2,120,0.2,10, wd_we_type = 1)
POK_indoor_bulb.windows([1170,1440],[0,30],0.35)
...
#Low Income Alleinerziehende
AE_indoor_bulb = AE.Appliance(AE,2,7,2,120,0.2,10, wd_we_type = 1)
AE_indoor_bulb.windows([1170,1440],[0,30],0.35)
...
EP_indoor_bulb = EP.Appliance(EP,2,7,2,120,0.2,10, wd_we_type = 1)
EP_indoor_bulb.windows([1170,1440],[0,30],0.35)
