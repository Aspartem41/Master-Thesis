# -*- coding: utf-8 -*-
"""
Created on Mon Nov 20 13:32:46 2023
...
SH_Lights= SH.Appliance(SH,18,36,1,180,v1,90, wd_we_type = 0, occasional_use = 0.01)
SH_Lights.windows(t1,t0,v1)

SH_Lights= SH.Appliance(SH,2,36,1,180,v1,90, wd_we_type = 0, occasional_use = 0.15)
SH_Lights.windows(t1,t0,v1)
