# -*- coding: utf-8 -*-
"""
Created on Mon Nov 20 20:36:53 2023
...
SH_Lights= SH.Appliance(SH,18,36,1,90,v1,90, wd_we_type = 0, occasional_use = 0.4)
SH_Lights.windows(t1,t0,v1)

SH_Lights= SH.Appliance(SH,2,36,1,360,v1,90, wd_we_type = 0, occasional_use = 0.4)
SH_Lights.windows(t1,t0,v1)
