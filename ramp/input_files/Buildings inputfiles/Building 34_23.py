# -*- coding: utf-8 -*-
"""
Created on Mon Nov 20 20:59:41 2023
...
SH_Lights= SH.Appliance(SH,18,36,1,60,v1,60, wd_we_type = 0, occasional_use = 0.2)
SH_Lights.windows(t1,t0,v1)

SH_Lights= SH.Appliance(SH,2,36,1,360,v1,90, wd_we_type = 0, occasional_use = 0.2)
SH_Lights.windows(t1,t0,v1)
