...
POK_bulb_living = POK.Appliance(POK,2,7,2,270,0.3,30)
POK_bulb_living.windows([360,510],[1170,1380],0.1)

POK_bulb_kitchen = POK.Appliance(POK,1,7,2,140,0.3,30)
POK_bulb_kitchen.windows([360,510],[1170,1260],0.1)

POK_bulb_bedroom = POK.Appliance(POK,1,7,2,60,0.3,30)
POK_bulb_bedroom.windows([360,420],[1170,1380],0.1)

POK_bulb_floor = POK.Appliance(POK,2,7,2,60,0.3,30)
...
POK_Waschmaschine = POK.Appliance(POK,1,1000,2,60,0.1,60, thermal_P_var = 0.2, occasional_use = 0.45)
...
#%%'
# Paar ohne Kind
POK_bulb_living = POK.Appliance(POK,2,7,2,270,0.3,10, wd_we_type = 1)
POK_bulb_living.windows([450,570],[1050,1440],0.1)

POK_bulb_kitchen = POK.Appliance(POK,1,7,2,140,0.3,10, wd_we_type = 1)
POK_bulb_kitchen.windows([450,540],[1140,1320],0.1)

POK_bulb_bedroom = POK.Appliance(POK,1,7,2,60,0.3,10, wd_we_type = 1)
POK_bulb_bedroom.windows([450,540],[1140,1440],0.1)

POK_bulb_floor = POK.Appliance(POK,2,7,2,60,0.3,10, wd_we_type = 1)
...
POK_Waschmaschine = POK.Appliance(POK,1,1000,2,60,0.1,60, thermal_P_var = 0.2, occasional_use = 0.45, wd_we_type = 1)
POK_Waschmaschine.windows([540,720],[960,1260],0.1)
