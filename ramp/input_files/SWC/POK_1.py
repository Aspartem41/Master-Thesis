...
POK_bulb_living = POK.Appliance(POK,2,7,2,360,0.35,30)
POK_bulb_living.windows([330,480],[1140,1380],0.1)

POK_bulb_kitchen = POK.Appliance(POK,1,7,2,180,0.35,30)
POK_bulb_kitchen.windows([330,480],[1140,1260],0.1)

POK_bulb_bedroom = POK.Appliance(POK,1,7,2,60,0.35,30)
POK_bulb_bedroom.windows([330,390],[1140,1380],0.1)

POK_bulb_floor = POK.Appliance(POK,2,7,2,60,0.35,30)
POK_bulb_floor.windows([330,450],[1140,1320],0.1)
...
POK_Mixer.windows([360,420],[660,750],0.1)

POK_Toaster = POK.Appliance(POK,1,1000,2,10,0.1,5, occasional_use = 0.5)
POK_Toaster.windows([420,720],[960,1260],0.1)
...
POK_Luftfritteuse.windows([420,720],[960,1260], 0.1)
...
#%%'
# Paar ohne Kind
POK_bulb_living = POK.Appliance(POK,2,7,2,360,0.35,10, wd_we_type = 1)
POK_bulb_living.windows([450,570],[990,1440],0.1)

POK_bulb_kitchen = POK.Appliance(POK,1,7,2,180,0.35,10, wd_we_type = 1)
POK_bulb_kitchen.windows([450,540],[1140,1320],0.1)

POK_bulb_bedroom = POK.Appliance(POK,1,7,2,60,0.35,10, wd_we_type = 1)
POK_bulb_bedroom.windows([450,540],[1080,1440],0.1)

POK_bulb_floor = POK.Appliance(POK,2,7,2,60,0.35,10, wd_we_type = 1)
POK_bulb_floor.windows([450,540],[1080,1260],0.1)

POK_outdoor_bulb = POK.Appliance(POK,1,13,2,15,0.2,1, wd_we_type = 1)   # Meistens mit Bewegungssensor, deswegen nur 10 minuten
POK_outdoor_bulb.windows([0,330],[990,1440],0.1)
...
POK_Mixer.windows([420,720],[960,1260],0.1)
