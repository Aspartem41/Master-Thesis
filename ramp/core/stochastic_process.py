...
def Stochastic_Process(j,r, year, start_month, end_month, num_pro):
    Profile, num_profiles = Initialise_model(year, num_pro )
    peak_enlarg, mu_peak, s_peak, op_factor, Year_behaviour, User_list = Initialise_inputs(j,r,year, start_month, end_month)
    '''
