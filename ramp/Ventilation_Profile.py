...
plt.title('Ventilation Consumption of Building 34' , fontsize=20, fontweight='bold')
plt.xlabel('Hours' ,fontsize=19, fontweight= 'bold')
plt.ylabel('Power Consumption (kW)', fontsize=19, fontweight= 'bold')
#plt.ylim(0)
plt.tight_layout()
plt.show()
plt.savefig(f'Results/Ventilation Plots/Ventilation Consumption of Building 34.jpeg',bbox_inches='tight')
