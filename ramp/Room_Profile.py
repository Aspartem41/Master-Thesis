...
plt.title(f'Load Profile of {Room}', fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.show()
# #plt.savefig(f'Load Profile of Building {Room_code}.jpeg',bbox_inches='tight')
...
plt.tight_layout()
plt.show()
#plt.savefig(f'Hourly Load Profile of Building {Room_code}.jpeg',bbox_inches='tight')
