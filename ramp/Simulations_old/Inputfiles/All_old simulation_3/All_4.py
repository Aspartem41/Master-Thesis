...
# EP_bulb2_bedroom_2.windows([1080,1140],t0,v1)
...
EP_outdoor_bulb_2.windows([1080,1440],t0,0)
...
EP_bulb_living_1_2 = EP.Appliance(EP,1,10,1,210,v3,210, wd_we_type = 1)
...
EP_bulb_BT_hallway_1 = EP.Appliance(EP,1,10,1,30,0.3,30, wd_we_type = 1)
EP_bulb_BT_hallway_1.windows(t11,t0,v1)

EP_bulb_BT_hallway_2 = EP.Appliance(EP,1,10,1,30,0.3,30, wd_we_type = 1)
...
# AE_bulb2_bedroom_2.windows([1080,1140],t0,v1)
...
AE_bulb_living_1_2 = AE.Appliance(AE,1,10,1,210,v3,210, wd_we_type = 1)
...
AE_bulb_BT_hallway_1 = AE.Appliance(AE,1,10,1,30,0.3,15, wd_we_type = 1)
AE_bulb_BT_hallway_1.windows(t11,t0,v1)

AE_bulb_BT_hallway_2 = AE.Appliance(AE,1,10,1,30,0.3,15, wd_we_type = 1)
...
POK_bulb_living_1_1= POK.Appliance(POK,2,10,1,60,v3,60, wd_we_type = 0)
POK_bulb_living_1_1.windows(t1,t0,v1)

POK_bulb_living_1_2 = POK.Appliance(POK,2,10,1,210,v3,210, wd_we_type = 0)
...
POK_outdoor_bulb_2.windows([1080,1440],t0,0)
...
POK_bulb_living_1_2 = POK.Appliance(POK,2,10,1,210,v3,210, wd_we_type = 1)
...
POK_bulb2_bedroom_2 = POK.Appliance(POK,1,10,1,20,v3,20, wd_we_type = 1)
...
POK_bulb_BT_hallway_1 = POK.Appliance(POK,2,10,1,15,0.3,10, wd_we_type = 1)
POK_bulb_BT_hallway_1.windows(t11,t0,v1)

POK_bulb_BT_hallway_2 = POK.Appliance(POK,2,10,1,20,0.3,10, wd_we_type = 1)
...
PMK_bulb_living_1_2 = PMK.Appliance(PMK,3,10,1,210,v3,210, wd_we_type = 0)
...
PMK_bulb2_bedroom_2.windows([1080,1140],t0,v1)
...
PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,2,10,1,15,0.3,10, wd_we_type = 0)
PMK_bulb_BT_hallway_1.windows(t1,t0,v1)

PMK_bulb_BT_hallway_2 = PMK.Appliance(PMK,2,10,1,20,0.3,10, wd_we_type = 0)
...
PMK_outdoor_bulb_2.windows([1080,1440],t0,0)
...
PMK_bulb_living_1_2 = PMK.Appliance(PMK,3,10,1,210,v3,210, wd_we_type = 1)
...
PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,2,10,1,15,0.3,10, wd_we_type = 1)
PMK_bulb_BT_hallway_1.windows(t11,t0,v1)

PMK_bulb_BT_hallway_2 = PMK.Appliance(PMK,2,10,1,20,0.3,10, wd_we_type = 1)
PMK_bulb_BT_hallway_2.windows([1080,1440],t0,0)

PMK_outdoor_bulb_1 = PMK.Appliance(PMK,2,13,1,10,v3,10, wd_we_type = 1)   
PMK_outdoor_bulb_1.windows([0,510],t0,0)

PMK_outdoor_bulb_2 = PMK.Appliance(PMK,2,13,1,15,v3,15, wd_we_type = 1)  
PMK_outdoor_bulb_2.windows([1080,1440],t0,0)
...
MP_bulb_living_1_2 = MP.Appliance(MP,4,10,1,210,v3,210, wd_we_type = 0)
...
MP_bulb2_bedroom_2.windows([1080,1140],t0,v1)
...
MP_bulb_BT_hallway_1 = MP.Appliance(MP,3,10,1,20,0.3,10, wd_we_type = 0)
MP_bulb_BT_hallway_1.windows(t1,t0,v1)

MP_bulb_BT_hallway_2 = MP.Appliance(MP,3,10,1,20,0.3,10, wd_we_type = 0)
...
MP_outdoor_bulb_2.windows([1080,1440],t0,0)
...
MP_bulb_living_1_2 = MP.Appliance(MP,4,10,1,210,v3,210, wd_we_type = 1)
...
MP_bulb_BT_hallway_1 = MP.Appliance(MP,3,10,1,20,0.3,10, wd_we_type = 1)
MP_bulb_BT_hallway_1.windows(t11,t0,v1)

MP_bulb_BT_hallway_2 = MP.Appliance(MP,3,10,1,20,0.3,10, wd_we_type = 1)
