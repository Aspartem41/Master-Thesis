...
EP_bulb_living_1_1= EP.Appliance(EP,1,10,1,120,0.5,120, wd_we_type = 1)
...
EP_bulb_kitchen_3 = EP.Appliance(EP,1,10,1,60,v1,60, wd_we_type = 1)
EP_bulb_kitchen_3.windows([1200,1290],t0,v1)

EP_bulb1_bedroom_1 = EP.Appliance(EP,1,10,1,60,v1,60, wd_we_type = 1)
...
EP_bulb_BT_hallway_1 = EP.Appliance(EP,1,10,1,30,0.25,30, wd_we_type = 1)
...
EP_outdoor_bulb_2 = EP.Appliance(EP,1,13,1,5,v1,5, wd_we_type = 1)  
...
AE_bulb_living_1_1= AE.Appliance(AE,1,10,1,120,0.5,120, wd_we_type = 1)
...
AE_bulb_kitchen_3 = AE.Appliance(AE,1,10,1,60,v1,60, wd_we_type = 1)
AE_bulb_kitchen_3.windows([1200,1290],t0,v1)

AE_bulb1_bedroom_1 = AE.Appliance(AE,1,10,1,60,v1,60, wd_we_type = 1)
...
AE_outdoor_bulb_2 = AE.Appliance(AE,1,13,1,5,v1,5, wd_we_type = 1)  
...
POK_bulb_living_1_1= POK.Appliance(POK,2,10,1,30,0.5,30, wd_we_type = 0)
POK_bulb_living_1_1.windows(t1,t0,v1)

POK_bulb_living_1_2 = POK.Appliance(POK,2,10,1,90,0.5,90, wd_we_type = 0)
...
POK_bulb_living_1_1= POK.Appliance(POK,2,10,1,120,0.5,120, wd_we_type = 1)
...
POK_bulb_kitchen_3 = POK.Appliance(POK,1,10,1,60,v1,60, wd_we_type = 1)
POK_bulb_kitchen_3.windows([1200,1290],t0,v1)

POK_bulb1_bedroom_1 = POK.Appliance(POK,1,10,1,60,v1,60, wd_we_type = 1)
...
POK_bulb2_bedroom_1 = POK.Appliance(POK,1,10,1,5,v1,5, wd_we_type = 1)
...
POK_bulb_BT_hallway_1 = POK.Appliance(POK,2,10,1,20,0.25,20, wd_we_type = 1)
...
POK_outdoor_bulb_2 = POK.Appliance(POK,1,13,1,5,v1,5, wd_we_type = 1)  
...
PMK_bulb_living_1_1= PMK.Appliance(PMK,3,10,1,30,0.5,30, wd_we_type = 0)
PMK_bulb_living_1_1.windows(t1,t0,v1)

PMK_bulb_living_1_2 = PMK.Appliance(PMK,3,10,1,90,0.5,90, wd_we_type = 0)
...
PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,2,10,1,5,0.25,5, wd_we_type = 0)
PMK_bulb_BT_hallway_1.windows(t1,t0,v1)

PMK_bulb_BT_hallway_2 = PMK.Appliance(PMK,2,10,1,15,0.25,15, wd_we_type = 0)
...
PMK_bulb_living_1_1= PMK.Appliance(PMK,3,10,1,120,0.5,120, wd_we_type = 1)
...
PMK_bulb_kitchen_3 = PMK.Appliance(PMK,1,10,1,60,v1,60, wd_we_type = 1)
PMK_bulb_kitchen_3.windows([1200,1290],t0,v1)

PMK_bulb1_bedroom_1 = PMK.Appliance(PMK,1,10,1,60,v1,60, wd_we_type = 1)
...
PMK_bulb2_bedroom_1 = PMK.Appliance(PMK,1,10,1,60,v1,60, wd_we_type = 1)
...
PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,2,10,1,20,0.25,20, wd_we_type = 1)
...
PMK_outdoor_bulb_2 = PMK.Appliance(PMK,2,13,1,5,v1,5, wd_we_type = 1)  
...
MP_bulb_living_1_1= MP.Appliance(MP,4,10,1,30,0.5,30, wd_we_type = 0)
MP_bulb_living_1_1.windows(t1,t0,v1)

MP_bulb_living_1_2 = MP.Appliance(MP,4,10,1,90,0.5,90, wd_we_type = 0)
...
MP_bulb_BT_hallway_1 = MP.Appliance(MP,3,10,1,5,0.25,5, wd_we_type = 0)
MP_bulb_BT_hallway_1.windows(t1,t0,v1)

MP_bulb_BT_hallway_2 = MP.Appliance(MP,3,10,1,15,0.25,15, wd_we_type = 0)
...
MP_TV_2= MP.Appliance(MP,2,60,1,30,v1,30, wd_we_type = 0)
...
MP_bulb_living_1_1= MP.Appliance(MP,4,10,1,120,0.5,120, wd_we_type = 1)
...
MP_bulb_kitchen_3 = MP.Appliance(MP,2,10,1,60,v1,60, wd_we_type = 1)
MP_bulb_kitchen_3.windows([1200,1290],t0,v1)

MP_bulb1_bedroom_1 = MP.Appliance(MP,1,10,1,60,v1,60, wd_we_type = 1)
...
MP_bulb2_bedroom_1 = MP.Appliance(MP,1,10,1,60,v1,60, wd_we_type = 1)
...
MP_bulb3_bedroom_1 = MP.Appliance(MP,1,10,1,60,v1,60, wd_we_type = 1)
...
MP_bulb_BT_hallway_1 = MP.Appliance(MP,3,10,1,20,0.25,20, wd_we_type = 1)
...
MP_outdoor_bulb_2 = MP.Appliance(MP,2,13,1,5,v1,5, wd_we_type = 1)  
...
MP_TV_2= MP.Appliance(MP,2,60,1,60,v2,60, wd_we_type = 1)
MP_TV_2.windows([840,1020],t0,v1)

MP_TV_3= MP.Appliance(MP,2,60,1,60,v2,60, wd_we_type = 1)
