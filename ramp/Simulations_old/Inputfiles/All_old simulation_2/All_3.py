# -*- coding: utf-8 -*-
"""
Created on Wed May  3 14:58:20 2023
...
EP_bulb_living_1_1= EP.Appliance(EP,1,10,1,30,0.5,30, wd_we_type = 0)
EP_bulb_living_1_1.windows(t1,t0,v1)

EP_bulb_living_1_2 = EP.Appliance(EP,1,10,1,90,0.5,90, wd_we_type = 0)
EP_bulb_living_1_2.windows(t11,t0,v1)

EP_bulb_kitchen_1= EP.Appliance(EP,1,10,1,15,v1,15, wd_we_type = 0)
EP_bulb_kitchen_1.windows(t1,t0,v1)

EP_bulb_kitchen_2= EP.Appliance(EP,1,10,1,45,v1,45, wd_we_type = 0)
EP_bulb_kitchen_2.windows([1200,1290],t0,v1)

EP_bulb1_bedroom_1= EP.Appliance(EP,1,10,1,30,v1,30, wd_we_type = 0)
EP_bulb1_bedroom_1.windows(t1,t0,v1)

EP_bulb1_bedroom_2= EP.Appliance(EP,1,10,1,30,v1,30, wd_we_type = 0)
EP_bulb1_bedroom_2.windows(t11,t0,v1)
...
# EP_bulb2_bedroom_3.windows(t11,t0,v1)
...
# EP_bulb3_bedroom_2.windows(t11,t0,v1)

EP_bulb_BT_hallway_1 = EP.Appliance(EP,1,10,1,5,0.25,5, wd_we_type = 0)
EP_bulb_BT_hallway_1.windows(t1,t0,v1)

EP_bulb_BT_hallway_2 = EP.Appliance(EP,1,10,1,25,0.25,25, wd_we_type = 0)
EP_bulb_BT_hallway_2.windows(t11,t0,v1)

# EP_outdoor_bulb_1 = EP.Appliance(EP,2,13,1,5,v1,5, wd_we_type = 0)   
# EP_outdoor_bulb_1.windows([0,330],t0,0)

EP_outdoor_bulb_2 = EP.Appliance(EP,1,13,1,5,v1,5, wd_we_type = 0)   
EP_outdoor_bulb_2.windows(t12,t0,0)
...
EP_bulb_living_1_1= EP.Appliance(EP,1,10,1,120,v2,120, wd_we_type = 1)
EP_bulb_living_1_1.windows(t12,t0,v1)

# EP_bulb_living_1_2 = EP.Appliance(EP,2,10,1,150,0,150, wd_we_type = 1)
# EP_bulb_living_1_2.windows([1080,1440],t0,0)

# EP_bulb_kitchen_1 = EP.Appliance(EP,2,10,1,30,0,30, wd_we_type = 1)
...
EP_bulb_kitchen_3 = EP.Appliance(EP,1,10,1,60,v2,60, wd_we_type = 1)
EP_bulb_kitchen_3.windows([1200,1290],t0,v1)

EP_bulb1_bedroom_1 = EP.Appliance(EP,1,10,1,60,v2,60, wd_we_type = 1)
EP_bulb1_bedroom_1.windows(t12,t0,v1)

# EP_bulb1_bedroom_2 = EP.Appliance(EP,1,10,1,30,0,30, wd_we_type = 1)
# EP_bulb1_bedroom_2.windows([1320,1440],t0,v1)

# EP_bulb2_bedroom_1 = EP.Appliance(EP,1,10,1,60,0,60, wd_we_type = 1)
# EP_bulb2_bedroom_1.windows(t12,t0,v1)

# EP_bulb2_bedroom_2 = EP.Appliance(EP,1,10,1,30,0,30, wd_we_type = 1)
# EP_bulb2_bedroom_2.windows([1080,1320],t0,0)

# EP_bulb2_bedroom_3 = EP.Appliance(EP,1,10,1,30,0,30, wd_we_type = 1)
# EP_bulb2_bedroom_3.windows([1320,1440],t0,v1)

# EP_bulb3_bedroom_1 = EP.Appliance(EP,1,10,1,60,0,60, wd_we_type = 1)
# EP_bulb3_bedroom_1.windows(t12,t0,v1)

# EP_bulb3_bedroom_2 = EP.Appliance(EP,1,10,1,30,0,30, wd_we_type = 1)
# EP_bulb3_bedroom_2.windows([1320,1440],t0,v1)

EP_bulb_BT_hallway_1 = EP.Appliance(EP,1,10,1,30,v2,30, wd_we_type = 1)
EP_bulb_BT_hallway_1.windows(t12,t0,v1)

# EP_bulb_BT_hallway_2 = EP.Appliance(EP,4,10,1,20,0,10, wd_we_type = 1)
# EP_bulb_BT_hallway_2.windows([1080,1440],t0,0)

# EP_outdoor_bulb_1 = EP.Appliance(EP,1,13,1,5,0,5, wd_we_type = 1)   
# EP_outdoor_bulb_1.windows([0,330],t0,0)

EP_outdoor_bulb_2 = EP.Appliance(EP,1,13,1,5,v2,5, wd_we_type = 1)  
EP_outdoor_bulb_2.windows(t12,t0,v1)
...
EP_Waschmaschine = EP.Appliance(EP,1,1000,3,60,0,60, thermal_P_var = 0.2, occasional_use = 0.33)
EP_Waschmaschine.windows([420,540],[540,720],v1,[1020,1260])
...
AE_bulb_living_1_1= AE.Appliance(AE,1,10,1,30,0.5,30, wd_we_type = 0)
AE_bulb_living_1_1.windows(t1,t0,v1)

AE_bulb_living_1_2 = AE.Appliance(AE,1,10,1,90,0.5,90, wd_we_type = 0)
AE_bulb_living_1_2.windows(t11,t0,v1)

AE_bulb_kitchen_1= AE.Appliance(AE,1,10,1,15,v1,15, wd_we_type = 0)
AE_bulb_kitchen_1.windows(t1,t0,v1)

AE_bulb_kitchen_2= AE.Appliance(AE,1,10,1,45,v1,45, wd_we_type = 0)
AE_bulb_kitchen_2.windows([1200,1290],t0,v1)

AE_bulb1_bedroom_1= AE.Appliance(AE,1,10,1,30,v1,30, wd_we_type = 0)
AE_bulb1_bedroom_1.windows(t1,t0,v1)

AE_bulb1_bedroom_2= AE.Appliance(AE,1,10,1,30,v1,30, wd_we_type = 0)
AE_bulb1_bedroom_2.windows(t11,t0,v1)
...
# AE_bulb2_bedroom_3.windows(t11,t0,v1)
...
# AE_bulb3_bedroom_2.windows(t11,t0,v1)

AE_bulb_BT_hallway_1 = AE.Appliance(AE,1,10,1,5,0.25,5, wd_we_type = 0)
AE_bulb_BT_hallway_1.windows(t1,t0,v1)

AE_bulb_BT_hallway_2 = AE.Appliance(AE,1,10,1,25,0.25,15, wd_we_type = 0)
AE_bulb_BT_hallway_2.windows(t11,t0,v1)

# AE_outdoor_bulb_1 = AE.Appliance(AE,2,13,1,5,v1,5, wd_we_type = 0)   
# AE_outdoor_bulb_1.windows([0,330],t0,0)

AE_outdoor_bulb_2 = AE.Appliance(AE,1,13,1,5,v1,5, wd_we_type = 0)   
AE_outdoor_bulb_2.windows(t12,t0,0)
...
AE_bulb_living_1_1= AE.Appliance(AE,1,10,1,120,v2,120, wd_we_type = 1)
AE_bulb_living_1_1.windows(t12,t0,v1)

# AE_bulb_living_1_2 = AE.Appliance(AE,2,10,1,150,0,150, wd_we_type = 1)
...
AE_bulb_kitchen_3 = AE.Appliance(AE,1,10,1,60,v2,60, wd_we_type = 1)
AE_bulb_kitchen_3.windows([1200,1290],t0,v1)

AE_bulb1_bedroom_1 = AE.Appliance(AE,1,10,1,60,v2,60, wd_we_type = 1)
AE_bulb1_bedroom_1.windows(t12,t0,v1)

# AE_bulb1_bedroom_2 = AE.Appliance(AE,1,10,1,30,0,30, wd_we_type = 1)
# AE_bulb1_bedroom_2.windows([1320,1440],t0,v1)

# AE_bulb2_bedroom_1 = AE.Appliance(AE,1,10,1,60,0,60, wd_we_type = 1)
# AE_bulb2_bedroom_1.windows(t12,t0,v1)
...
# AE_bulb3_bedroom_1 = AE.Appliance(AE,1,10,1,60,0,60, wd_we_type = 1)
# AE_bulb3_bedroom_1.windows(t12,t0,v1)

# AE_bulb3_bedroom_2 = AE.Appliance(AE,1,10,1,30,0,30, wd_we_type = 1)
# AE_bulb3_bedroom_2.windows([1320,1440],t0,v1)

AE_bulb_BT_hallway_1 = AE.Appliance(AE,1,10,1,30,v2,15, wd_we_type = 1)
AE_bulb_BT_hallway_1.windows(t12,t0,v1)

# AE_bulb_BT_hallway_2 = AE.Appliance(AE,4,10,1,20,0,10, wd_we_type = 1)
# AE_bulb_BT_hallway_2.windows([1080,1440],t0,0)

# AE_outdoor_bulb_1 = AE.Appliance(AE,1,13,1,5,0,5, wd_we_type = 1)   
# AE_outdoor_bulb_1.windows([0,330],t0,0)

AE_outdoor_bulb_2 = AE.Appliance(AE,1,13,1,5,v2,5, wd_we_type = 1)  
AE_outdoor_bulb_2.windows(t12,t0,v1)
...
AE_Waschmaschine = AE.Appliance(AE,1,1000,3,60,0,60, thermal_P_var = 0.2, occasional_use = 0.33)
AE_Waschmaschine.windows([420,540],[540,720],v1,[1020,1260])
...
POK_bulb_living_1_1= POK.Appliance(POK,1,10,1,30,0.5,30, wd_we_type = 0)
POK_bulb_living_1_1.windows(t1,t0,v1)

POK_bulb_living_1_2 = POK.Appliance(POK,1,10,1,90,0.5,90, wd_we_type = 0)
POK_bulb_living_1_2.windows(t11,t0,v1)

POK_bulb_kitchen_1= POK.Appliance(POK,1,10,1,15,v1,15, wd_we_type = 0)
POK_bulb_kitchen_1.windows(t1,t0,v1)

POK_bulb_kitchen_2= POK.Appliance(POK,1,10,1,45,v1,45, wd_we_type = 0)
POK_bulb_kitchen_2.windows([1200,1290],t0,v1)

POK_bulb1_bedroom_1= POK.Appliance(POK,1,10,1,30,v1,30, wd_we_type = 0)
POK_bulb1_bedroom_1.windows(t1,t0,v1)

POK_bulb1_bedroom_2= POK.Appliance(POK,1,10,1,30,v1,30, wd_we_type = 0)
...
POK_bulb2_bedroom_3 = POK.Appliance(POK,1,10,1,5,v1,5, wd_we_type = 0)
...
POK_bulb_BT_hallway_1 = POK.Appliance(POK,2,10,1,5,0.25,5, wd_we_type = 0)
POK_bulb_BT_hallway_1.windows(t1,t0,v1)

POK_bulb_BT_hallway_2 = POK.Appliance(POK,2,10,1,15,0.25,15, wd_we_type = 0)
...
POK_outdoor_bulb_2 = POK.Appliance(POK,1,13,1,5,v1,5, wd_we_type = 0)   
...
POK_bulb_living_1_1= POK.Appliance(POK,1,10,1,120,v2,120, wd_we_type = 1)
...
POK_bulb_kitchen_3 = POK.Appliance(POK,1,10,1,60,v2,60, wd_we_type = 1)
POK_bulb_kitchen_3.windows([1200,1290],t0,v1)

POK_bulb1_bedroom_1 = POK.Appliance(POK,1,10,1,60,v2,60, wd_we_type = 1)
...
POK_bulb2_bedroom_1 = POK.Appliance(POK,1,10,1,5,v2,5, wd_we_type = 1)
...
POK_bulb_BT_hallway_1 = POK.Appliance(POK,2,10,1,20,v2,20, wd_we_type = 1)
...
POK_outdoor_bulb_2 = POK.Appliance(POK,1,13,1,5,v2,5, wd_we_type = 1)  
...
POK_Waschmaschine = POK.Appliance(POK,1,1000,3,60,0,60, thermal_P_var = 0.2, occasional_use = 0.33)
POK_Waschmaschine.windows([420,540],[540,720],v1,[1020,1260])
...
PMK_bulb_living_1_1= PMK.Appliance(PMK,2,10,1,30,0.5,30, wd_we_type = 0)
PMK_bulb_living_1_1.windows(t1,t0,v1)

PMK_bulb_living_1_2 = PMK.Appliance(PMK,2,10,1,90,0.5,90, wd_we_type = 0)
PMK_bulb_living_1_2.windows(t11,t0,v1)

PMK_bulb_kitchen_1= PMK.Appliance(PMK,1,10,1,15,v1,15, wd_we_type = 0)
PMK_bulb_kitchen_1.windows(t1,t0,v1)

PMK_bulb_kitchen_2= PMK.Appliance(PMK,1,10,1,45,v1,45, wd_we_type = 0)
PMK_bulb_kitchen_2.windows([1200,1290],t0,v1)

PMK_bulb1_bedroom_1= PMK.Appliance(PMK,1,10,1,30,v1,30, wd_we_type = 0)
PMK_bulb1_bedroom_1.windows(t1,t0,v1)

PMK_bulb1_bedroom_2= PMK.Appliance(PMK,1,10,1,30,v1,30, wd_we_type = 0)
PMK_bulb1_bedroom_2.windows(t11,t0,v1)

PMK_bulb2_bedroom_1 = PMK.Appliance(PMK,1,10,1,30,v1,30, wd_we_type = 0)
...
PMK_bulb2_bedroom_3 = PMK.Appliance(PMK,1,10,1,30,v1,30, wd_we_type = 0)
PMK_bulb2_bedroom_3.windows(t11,t0,v1)
...
# PMK_bulb3_bedroom_2.windows(t11,t0,v1)

PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,3,10,1,5,0.25,5, wd_we_type = 0)
PMK_bulb_BT_hallway_1.windows(t1,t0,v1)

PMK_bulb_BT_hallway_2 = PMK.Appliance(PMK,3,10,1,15,0.25,15, wd_we_type = 0)
PMK_bulb_BT_hallway_2.windows(t11,t0,v1)

# PMK_outdoor_bulb_1 = PMK.Appliance(PMK,2,13,1,5,v1,5, wd_we_type = 0)   
# PMK_outdoor_bulb_1.windows([0,330],t0,0)

PMK_outdoor_bulb_2 = PMK.Appliance(PMK,2,13,1,5,v1,5, wd_we_type = 0)   
PMK_outdoor_bulb_2.windows(t12,t0,0)
...
PMK_bulb_living_1_1= PMK.Appliance(PMK,2,10,1,120,v2,120, wd_we_type = 1)
PMK_bulb_living_1_1.windows(t12,t0,v1)

# PMK_bulb_living_1_2 = PMK.Appliance(PMK,2,10,1,150,0,150, wd_we_type = 1)
# PMK_bulb_living_1_2.windows([1080,1440],t0,0)
...
PMK_bulb_kitchen_3 = PMK.Appliance(PMK,1,10,1,60,v2,60, wd_we_type = 1)
PMK_bulb_kitchen_3.windows([1200,1290],t0,v1)

PMK_bulb1_bedroom_1 = PMK.Appliance(PMK,1,10,1,60,v2,60, wd_we_type = 1)
PMK_bulb1_bedroom_1.windows(t12,t0,v1)

# PMK_bulb1_bedroom_2 = PMK.Appliance(PMK,1,10,1,30,0,30, wd_we_type = 1)
# PMK_bulb1_bedroom_2.windows([1320,1440],t0,v1)

PMK_bulb2_bedroom_1 = PMK.Appliance(PMK,1,10,1,60,v2,60, wd_we_type = 1)
PMK_bulb2_bedroom_1.windows(t12,t0,v1)

# PMK_bulb2_bedroom_2 = PMK.Appliance(PMK,1,10,1,30,0,30, wd_we_type = 1)
# PMK_bulb2_bedroom_2.windows([1080,1320],t0,0)

# PMK_bulb2_bedroom_3 = PMK.Appliance(PMK,1,10,1,30,0,30, wd_we_type = 1)
# PMK_bulb2_bedroom_3.windows([1320,1440],t0,v1)

# PMK_bulb3_bedroom_1 = PMK.Appliance(PMK,1,10,1,60,0,60, wd_we_type = 1)
# PMK_bulb3_bedroom_1.windows(t12,t0,v1)

# PMK_bulb3_bedroom_2 = PMK.Appliance(PMK,1,10,1,30,0,30, wd_we_type = 1)
# PMK_bulb3_bedroom_2.windows([1320,1440],t0,v1)

PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,3,10,1,20,v2,20, wd_we_type = 1)
PMK_bulb_BT_hallway_1.windows(t12,t0,v1)

# PMK_bulb_BT_hallway_2 = PMK.Appliance(PMK,4,10,1,20,0,10, wd_we_type = 1)
# PMK_bulb_BT_hallway_2.windows([1080,1440],t0,0)

# PMK_outdoor_bulb_1 = PMK.Appliance(PMK,1,13,1,5,0,5, wd_we_type = 1)   
# PMK_outdoor_bulb_1.windows([0,330],t0,0)

PMK_outdoor_bulb_2 = PMK.Appliance(PMK,2,13,1,5,v2,5, wd_we_type = 1)  
PMK_outdoor_bulb_2.windows(t12,t0,v1)
...
PMK_Waschmaschine = PMK.Appliance(PMK,1,1000,3,60,0,60, thermal_P_var = 0.2, occasional_use = 0.5)
PMK_Waschmaschine.windows([420,540],[540,720],v1,[1020,1260])
...
MP_bulb_living_1_1= MP.Appliance(MP,2,10,1,30,0.5,30, wd_we_type = 0)
MP_bulb_living_1_1.windows(t1,t0,v1)

MP_bulb_living_1_2 = MP.Appliance(MP,2,10,1,90,0.5,90, wd_we_type = 0)
MP_bulb_living_1_2.windows(t11,t0,v1)

MP_bulb_kitchen_1= MP.Appliance(MP,2,10,1,15,v1,15, wd_we_type = 0)
MP_bulb_kitchen_1.windows(t1,t0,v1)

MP_bulb_kitchen_2= MP.Appliance(MP,2,10,1,45,v1,45, wd_we_type = 0)
MP_bulb_kitchen_2.windows([1200,1290],t0,v1)

MP_bulb1_bedroom_1= MP.Appliance(MP,1,10,1,30,v1,30, wd_we_type = 0)
MP_bulb1_bedroom_1.windows(t1,t0,v1)

MP_bulb1_bedroom_2= MP.Appliance(MP,1,10,1,30,v1,30, wd_we_type = 0)
MP_bulb1_bedroom_2.windows(t11,t0,v1)

MP_bulb2_bedroom_1 = MP.Appliance(MP,1,10,1,30,v1,30, wd_we_type = 0)
...
MP_bulb2_bedroom_3 = MP.Appliance(MP,1,10,1,30,v1,30, wd_we_type = 0)
MP_bulb2_bedroom_3.windows(t11,t0,v1)

MP_bulb3_bedroom_1 = MP.Appliance(MP,1,10,1,30,v1,30, wd_we_type = 0)
MP_bulb3_bedroom_1.windows(t1,t0,v1)

MP_bulb3_bedroom_2 = MP.Appliance(MP,1,10,1,30,v1,30, wd_we_type = 0)
MP_bulb3_bedroom_2.windows(t11,t0,v1)

MP_bulb_BT_hallway_1 = MP.Appliance(MP,4,10,1,5,0.25,5, wd_we_type = 0)
MP_bulb_BT_hallway_1.windows(t1,t0,v1)

MP_bulb_BT_hallway_2 = MP.Appliance(MP,4,10,1,15,0.25,15, wd_we_type = 0)
MP_bulb_BT_hallway_2.windows(t11,t0,v1)

# MP_outdoor_bulb_1 = MP.Appliance(MP,2,13,1,5,v1,5, wd_we_type = 0)   
# MP_outdoor_bulb_1.windows([0,330],t0,0)

MP_outdoor_bulb_2 = MP.Appliance(MP,2,13,1,5,v1,5, wd_we_type = 0)   
MP_outdoor_bulb_2.windows(t12,t0,0)
...
MP_bulb_living_1_1= MP.Appliance(MP,2,10,1,120,v2,120, wd_we_type = 1)
MP_bulb_living_1_1.windows(t12,t0,v1)

# MP_bulb_living_1_2 = MP.Appliance(MP,2,10,1,150,0,150, wd_we_type = 1)
# MP_bulb_living_1_2.windows([1080,1440],t0,0)
...
MP_bulb_kitchen_3 = MP.Appliance(MP,2,10,1,60,v2,60, wd_we_type = 1)
MP_bulb_kitchen_3.windows([1200,1290],t0,v1)

MP_bulb1_bedroom_1 = MP.Appliance(MP,1,10,1,60,v2,60, wd_we_type = 1)
MP_bulb1_bedroom_1.windows(t12,t0,v1)

# MP_bulb1_bedroom_2 = MP.Appliance(MP,1,10,1,30,0,30, wd_we_type = 1)
# MP_bulb1_bedroom_2.windows([1320,1440],t0,v1)

MP_bulb2_bedroom_1 = MP.Appliance(MP,1,10,1,60,v2,60, wd_we_type = 1)
MP_bulb2_bedroom_1.windows(t12,t0,v1)

# MP_bulb2_bedroom_2 = MP.Appliance(MP,1,10,1,30,0,30, wd_we_type = 1)
# MP_bulb2_bedroom_2.windows([1080,1320],t0,0)

# MP_bulb2_bedroom_3 = MP.Appliance(MP,1,10,1,30,0,30, wd_we_type = 1)
# MP_bulb2_bedroom_3.windows([1320,1440],t0,v1)

MP_bulb3_bedroom_1 = MP.Appliance(MP,1,10,1,60,v2,60, wd_we_type = 1)
MP_bulb3_bedroom_1.windows(t12,t0,v1)

# MP_bulb3_bedroom_2 = MP.Appliance(MP,1,10,1,30,0,30, wd_we_type = 1)
# MP_bulb3_bedroom_2.windows([1320,1440],t0,v1)

MP_bulb_BT_hallway_1 = MP.Appliance(MP,4,10,1,20,v2,20, wd_we_type = 1)
MP_bulb_BT_hallway_1.windows(t12,t0,v1)

# MP_bulb_BT_hallway_2 = MP.Appliance(MP,4,10,1,20,0,10, wd_we_type = 1)
# MP_bulb_BT_hallway_2.windows([1080,1440],t0,0)

# MP_outdoor_bulb_1 = MP.Appliance(MP,1,13,1,5,0,5, wd_we_type = 1)   
# MP_outdoor_bulb_1.windows([0,330],t0,0)

MP_outdoor_bulb_2 = MP.Appliance(MP,2,13,1,5,v2,5, wd_we_type = 1)  
MP_outdoor_bulb_2.windows(t12,t0,v1)

                              ###

MP_TV_1= MP.Appliance(MP,1,60,1,30,v2,30, wd_we_type = 1)
MP_TV_1.windows([540,720],t0,v1)

MP_TV_2= MP.Appliance(MP,1,60,1,60,v2,60, wd_we_type = 1)
MP_TV_2.windows([840,1020],t0,v1)

MP_TV_3= MP.Appliance(MP,1,60,1,60,v2,60, wd_we_type = 1)
...
MP_Waschmaschine = MP.Appliance(MP,1,1000,3,60,0,60, thermal_P_var = 0.2, occasional_use = 1)
MP_Waschmaschine.windows([420,540],[540,720],v1,[1020,1260])
