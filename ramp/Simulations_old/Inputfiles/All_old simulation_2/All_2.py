...
POK_bulb_living_1_1= POK.Appliance(POK,1,10,1,30,v3,30, wd_we_type = 0)
POK_bulb_living_1_1.windows(t1,t0,v1)

POK_bulb_living_1_2 = POK.Appliance(POK,1,10,1,150,v3,150, wd_we_type = 0)
...
PMK_bulb_living_1_1= PMK.Appliance(PMK,2,10,1,30,v3,30, wd_we_type = 0)
PMK_bulb_living_1_1.windows(t1,t0,v1)

PMK_bulb_living_1_2 = PMK.Appliance(PMK,2,10,1,150,v3,150, wd_we_type = 0)
...
PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,3,10,1,10,0.25,10, wd_we_type = 0)
PMK_bulb_BT_hallway_1.windows(t1,t0,v1)

PMK_bulb_BT_hallway_2 = PMK.Appliance(PMK,3,10,1,20,0.25,10, wd_we_type = 0)
...
MP_bulb_living_1_1= MP.Appliance(MP,2,10,1,30,v3,30, wd_we_type = 0)
MP_bulb_living_1_1.windows(t1,t0,v1)

MP_bulb_living_1_2 = MP.Appliance(MP,2,10,1,150,v3,150, wd_we_type = 0)
...
MP_bulb_BT_hallway_1 = MP.Appliance(MP,4,10,1,10,0.25,10, wd_we_type = 0)
MP_bulb_BT_hallway_1.windows(t1,t0,v1)

MP_bulb_BT_hallway_2 = MP.Appliance(MP,4,10,1,20,0.25,10, wd_we_type = 0)
