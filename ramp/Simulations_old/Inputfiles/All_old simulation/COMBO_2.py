...
POK_bulb_BT_hallway_1 = POK.Appliance(POK,2,10,1,10,0,10)
POK_bulb_BT_hallway_1.windows(t2,t0,0.1)
...
POK_Phone_charger_1.windows(t2,t0,0)
...
POK_Laptop_PC_charger_1.windows(t2,t0,0)
...
POK_bulb_living_1.windows(t1,t0,0.1)

POK_bulb_living_2 = POK.Appliance(POK,1,10,1,30,0.1,30, wd_we_type = 1)
POK_bulb_living_2.windows([1080,1140],t0,0.1)
...
POK_bulb_kitchen_3 = POK.Appliance(POK,1,10,1,100,0,100, wd_we_type = 1)
...
POK_bulb2_bedroom_1 = POK.Appliance(POK,1,10,1,10,0,10, wd_we_type = 1)
POK_bulb2_bedroom_1.windows([1140,1320],t0,0.1)

# POK_bulb2_bedroom_2 = POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 1)
# POK_bulb2_bedroom_2.windows([1080,1290],t0,0.1)

POK_bulb_BT_hallway_1 = POK.Appliance(POK,2,10,1,10,0,10, wd_we_type = 1)
POK_bulb_BT_hallway_1.windows(t1,t0,0.1)

POK_bulb_BT_hallway_2 = POK.Appliance(POK,2,10,1,20,0,20, wd_we_type = 1)
POK_bulb_BT_hallway_2.windows([1080,1380],t0,0)

POK_outdoor_bulb_1 = POK.Appliance(POK,1,13,1,5,0.1,5, wd_we_type = 1)   # Meistens mit Bewegungssensor, deswegen nur 15 minuten
POK_outdoor_bulb_1.windows([0,510],t0,0.1)

POK_outdoor_bulb_2 = POK.Appliance(POK,1,13,1,10,0.1,10, wd_we_type = 1)  
POK_outdoor_bulb_2.windows([1080,1440],t0,0.1)
...
PMK_bulb_living_1_1.windows([330,510],t0,0.1)

PMK_bulb_living_1_2 = PMK.Appliance(PMK,2,10,1,150,0,150)
PMK_bulb_living_1_2.windows([1140,1380],t0,0)

PMK_bulb_kitchen_1= PMK.Appliance(PMK,1,10,1,30,0,30)
PMK_bulb_kitchen_1.windows(t2,t0,0.1)

PMK_bulb_kitchen_2= PMK.Appliance(PMK,1,10,1,100,0,100)
PMK_bulb_kitchen_2.windows([1140,1290],t0,0.1)

PMK_bulb1_bedroom_1= PMK.Appliance(PMK,1,10,1,30,0,30)
PMK_bulb1_bedroom_1.windows([330,510],t0,0.1)
...
PMK_bulb2_bedroom_1.windows([330,510],t0,0.1)
...
PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,3,10,1,10,0,10)
PMK_bulb_BT_hallway_1.windows(t2,t0,0.1)
...
PMK_Phone_charger_1.windows(t2,t0,0)
...
PMK_Laptop_PC_charger_1.windows(t2,t0,0)
...
PMK_bulb_living_1.windows(t1,t0,0.1)

PMK_bulb_living_2 = PMK.Appliance(PMK,1,10,1,30,0.1,30, wd_we_type = 1)
...
PMK_bulb_kitchen_3 = PMK.Appliance(PMK,1,10,1,100,0,100, wd_we_type = 1)
...
PMK_bulb2_bedroom_2.windows([1080,1320],t0,0.1)

PMK_bulb2_bedroom_3 = PMK.Appliance(PMK,1,10,1,30,0,30, wd_we_type = 1)
PMK_bulb2_bedroom_3.windows([1320,1440],t0,0.1)

PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,3,10,1,10,0,10, wd_we_type = 1)
