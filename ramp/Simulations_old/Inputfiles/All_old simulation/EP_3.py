...
EP_bulb_living_1_1= EP.Appliance(EP,1,10,1,120,0,120, wd_we_type = 1)
...
EP_bulb_kitchen_3 = EP.Appliance(EP,1,10,1,60,0,60, wd_we_type = 1)
EP_bulb_kitchen_3.windows([1200,1290],t0,v1)

EP_bulb1_bedroom_1 = EP.Appliance(EP,1,10,1,60,0,60, wd_we_type = 1)
...
EP_outdoor_bulb_2 = EP.Appliance(EP,1,13,1,5,0,5, wd_we_type = 1)  
