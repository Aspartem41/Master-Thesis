...
EP_bulb_living_1_1= EP.Appliance(EP,1,10,1,30,0,30, wd_we_type = 0)
EP_bulb_living_1_1.windows(t1,t0,v1)

EP_bulb_living_1_2 = EP.Appliance(EP,1,10,1,90,0,90, wd_we_type = 0)
EP_bulb_living_1_2.windows(t11,t0,v1)

EP_bulb_kitchen_1= EP.Appliance(EP,1,10,1,15,0,15, wd_we_type = 0)
EP_bulb_kitchen_1.windows(t1,t0,v1)

EP_bulb_kitchen_2= EP.Appliance(EP,1,10,1,45,0,45, wd_we_type = 0)
...
EP_bulb_BT_hallway_1 = EP.Appliance(EP,1,10,1,5,0,5, wd_we_type = 0)
EP_bulb_BT_hallway_1.windows(t1,t0,v1)

EP_bulb_BT_hallway_2 = EP.Appliance(EP,1,10,1,25,0,25, wd_we_type = 0)
...
EP_outdoor_bulb_2 = EP.Appliance(EP,1,13,1,5,0,5, wd_we_type = 0)   
...
EP_bulb_living_1_1.windows(t12,t0,v2)
...
EP_bulb_kitchen_3.windows([1200,1290],t0,v2)

EP_bulb1_bedroom_1 = EP.Appliance(EP,1,10,1,60,v2,60, wd_we_type = 1)
EP_bulb1_bedroom_1.windows(t12,t0,v2)
...
EP_bulb_BT_hallway_1.windows(t12,t0,v2)
...
EP_outdoor_bulb_2.windows(t12,t0,v2)
...
AE_bulb_living_1_2 = AE.Appliance(AE,1,10,1,90,0,90, wd_we_type = 0)
AE_bulb_living_1_2.windows(t11,t0,v1)

AE_bulb_kitchen_1= AE.Appliance(AE,1,10,1,15,0,15, wd_we_type = 0)
AE_bulb_kitchen_1.windows(t1,t0,v1)

AE_bulb_kitchen_2= AE.Appliance(AE,1,10,1,45,0,45, wd_we_type = 0)
...
AE_bulb_BT_hallway_1 = AE.Appliance(AE,1,10,1,5,0,5, wd_we_type = 0)
AE_bulb_BT_hallway_1.windows(t1,t0,v1)

AE_bulb_BT_hallway_2 = AE.Appliance(AE,1,10,1,25,0,15, wd_we_type = 0)
...
AE_bulb_living_1_1.windows(t12,t0,v2)
...
AE_bulb_kitchen_3.windows([1200,1290],t0,v2)

AE_bulb1_bedroom_1 = AE.Appliance(AE,1,10,1,60,v2,60, wd_we_type = 1)
AE_bulb1_bedroom_1.windows(t12,t0,v2)
...
AE_bulb_BT_hallway_1.windows(t12,t0,v2)
...
AE_outdoor_bulb_2.windows(t12,t0,v2)
...
POK_bulb_living_1_1.windows(t12,t0,v2)
...
POK_bulb_kitchen_3.windows([1200,1290],t0,v2)

POK_bulb1_bedroom_1 = POK.Appliance(POK,1,10,1,60,v2,60, wd_we_type = 1)
POK_bulb1_bedroom_1.windows(t12,t0,v2)
...
POK_bulb2_bedroom_1.windows(t12,t0,v2)
...
POK_bulb_BT_hallway_1.windows(t12,t0,v2)
...
POK_outdoor_bulb_2.windows(t12,t0,v2)
...
PMK_bulb_living_1_1= PMK.Appliance(PMK,2,10,1,30,0,30, wd_we_type = 0)
PMK_bulb_living_1_1.windows(t1,t0,v1)

PMK_bulb_living_1_2 = PMK.Appliance(PMK,2,10,1,90,0,90, wd_we_type = 0)
PMK_bulb_living_1_2.windows(t11,t0,v1)

PMK_bulb_kitchen_1= PMK.Appliance(PMK,1,10,1,15,0,15, wd_we_type = 0)
PMK_bulb_kitchen_1.windows(t1,t0,v1)

PMK_bulb_kitchen_2= PMK.Appliance(PMK,1,10,1,45,0,45, wd_we_type = 0)
...
PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,3,10,1,5,0,5, wd_we_type = 0)
PMK_bulb_BT_hallway_1.windows(t1,t0,v1)

PMK_bulb_BT_hallway_2 = PMK.Appliance(PMK,3,10,1,15,0,15, wd_we_type = 0)
...
PMK_outdoor_bulb_2 = PMK.Appliance(PMK,2,13,1,5,0,5, wd_we_type = 0)   
...
PMK_bulb_living_1_1.windows(t12,t0,v2)
...
PMK_bulb_kitchen_3.windows([1200,1290],t0,v2)

PMK_bulb1_bedroom_1 = PMK.Appliance(PMK,1,10,1,60,v2,60, wd_we_type = 1)
PMK_bulb1_bedroom_1.windows(t12,t0,v2)
...
PMK_bulb2_bedroom_1.windows(t12,t0,v2)
...
PMK_bulb_BT_hallway_1.windows(t12,t0,v2)
...
PMK_outdoor_bulb_2.windows(t12,t0,v2)
...
MP_bulb_living_1_1= MP.Appliance(MP,2,10,1,30,0,30, wd_we_type = 0)
MP_bulb_living_1_1.windows(t1,t0,v1)

MP_bulb_living_1_2 = MP.Appliance(MP,2,10,1,90,0,90, wd_we_type = 0)
MP_bulb_living_1_2.windows(t11,t0,v1)

MP_bulb_kitchen_1= MP.Appliance(MP,2,10,1,15,0,15, wd_we_type = 0)
MP_bulb_kitchen_1.windows(t1,t0,v1)

MP_bulb_kitchen_2= MP.Appliance(MP,2,10,1,45,0,45, wd_we_type = 0)
...
MP_bulb_BT_hallway_1 = MP.Appliance(MP,4,10,1,5,0,5, wd_we_type = 0)
MP_bulb_BT_hallway_1.windows(t1,t0,v1)

MP_bulb_BT_hallway_2 = MP.Appliance(MP,4,10,1,15,0,15, wd_we_type = 0)
...
MP_outdoor_bulb_2 = MP.Appliance(MP,2,13,1,5,0,5, wd_we_type = 0)   
...
MP_bulb_living_1_1.windows(t12,t0,v2)
...
MP_bulb_kitchen_3.windows([1200,1290],t0,v2)

MP_bulb1_bedroom_1 = MP.Appliance(MP,1,10,1,60,v2,60, wd_we_type = 1)
MP_bulb1_bedroom_1.windows(t12,t0,v2)
...
MP_bulb2_bedroom_1.windows(t12,t0,v2)
...
MP_bulb3_bedroom_1.windows(t12,t0,v2)
...
MP_bulb_BT_hallway_1.windows(t12,t0,v2)
...
MP_outdoor_bulb_2.windows(t12,t0,v2)
