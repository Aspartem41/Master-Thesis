...
PMK_bulb_living_1_2 = PMK.Appliance(PMK,2,10,1,300,0,300, wd_we_type = 1)
...
PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,3,10,1,30,0,15, wd_we_type = 1)
PMK_bulb_BT_hallway_1.windows(t11,t0,v1)

PMK_bulb_BT_hallway_2 = PMK.Appliance(PMK,3,10,1,30,0,15, wd_we_type = 1)
PMK_bulb_BT_hallway_2.windows([960,1440],t0,0)

PMK_outdoor_bulb_1 = PMK.Appliance(PMK,1,13,1,10,0,10, wd_we_type = 1)   
PMK_outdoor_bulb_1.windows([0,510],t0,0)

PMK_outdoor_bulb_2 = PMK.Appliance(PMK,1,13,1,30,0,30, wd_we_type = 1)  
...
# PMK_bulb_living_1_1 = PMK.Appliance(PMK,2,10,1,120,0,120, wd_we_type = 0)
# PMK_bulb_living_1_1.windows([450,570],t0,0.1)
