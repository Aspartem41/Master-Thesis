...
EP_bulb_living_1_1= EP.Appliance(EP,1,10,1,30,0,30, wd_we_type = 1)
EP_bulb_living_1_1.windows(t11,t0,v1)

EP_bulb_living_1_2 = EP.Appliance(EP,1,10,1,150,0,150, wd_we_type = 1)
...
EP_bulb_kitchen_3 = EP.Appliance(EP,1,10,1,100,0,100, wd_we_type = 1)
...
EP_bulb_BT_hallway_1 = EP.Appliance(EP,1,10,1,30,0,15, wd_we_type = 1)
EP_bulb_BT_hallway_1.windows(t11,t0,v1)

EP_bulb_BT_hallway_2 = EP.Appliance(EP,1,10,1,30,0,15, wd_we_type = 1)
