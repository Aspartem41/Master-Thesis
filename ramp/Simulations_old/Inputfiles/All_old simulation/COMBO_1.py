# -*- coding: utf-8 -*-
"""
Created on Fri Apr 14 14:19:53 2023
...
t2 = [960,1140] # 16:00 - 19:00
#%%'
# Paar ohne Kind

POK_bulb_living_1_1 = POK.Appliance(POK,1,10,1,120,0,120)
POK_bulb_living_1_1.windows([330,570],t0,0.1)

POK_bulb_living_1_2 = POK.Appliance(POK,1,10,1,240,0,240)
POK_bulb_living_1_2.windows([1140,1380],t0,0)

POK_bulb_kitchen_1= POK.Appliance(POK,1,10,1,60,0,60)
POK_bulb_kitchen_1.windows(t1,t0,0.1)

POK_bulb_kitchen_2= POK.Appliance(POK,1,10,1,120,0,120)
POK_bulb_kitchen_2.windows([1140,1290],t0,0.1)

POK_bulb1_bedroom_1= POK.Appliance(POK,1,10,1,30,0,30)
POK_bulb1_bedroom_1.windows([330,540],t0,0.1)

POK_bulb1_bedroom_2= POK.Appliance(POK,1,10,1,30,0,30)
POK_bulb1_bedroom_2.windows([1320,1440],t0,0.1)

POK_bulb2_bedroom_1 = POK.Appliance(POK,1,10,1,15,0,15)
POK_bulb2_bedroom_1.windows([330,480],t0,0.1)

POK_bulb2_bedroom_2 = POK.Appliance(POK,1,10,1,30,0,30)
POK_bulb2_bedroom_2.windows([1140,1290],t0,0.1)

POK_bulb_BT_hallway_1 = POK.Appliance(POK,2,10,1,30,0,15)
POK_bulb_BT_hallway_1.windows(t1,t0,0.1)

POK_bulb_BT_hallway_2 = POK.Appliance(POK,2,10,1,30,0,15)
POK_bulb_BT_hallway_2.windows([1140,1380],t0,0)

POK_outdoor_bulb_1 = POK.Appliance(POK,1,13,1,10,0.1,10)   # Meistens mit Bewegungssensor, deswegen nur 15 minuten
POK_outdoor_bulb_1.windows([0,510],t0,0)

POK_outdoor_bulb_2 = POK.Appliance(POK,1,13,1,10,0.1,10)   
POK_outdoor_bulb_2.windows([1140,1440],t0,0)
...
POK_Phone_charger_1.windows(t1,t0,0)
...
POK_Laptop_PC_charger_1.windows(t1,t0,0)
...
# POK_Herd.cycle_behaviour([720,900],t0)
...
POK_bulb_living_3.windows([1140,1440],t0,0)
...
POK_bulb_kitchen_3.windows([1140,1320],t0,0.1)

POK_bulb1_bedroom_1 = POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 1)
POK_bulb1_bedroom_1.windows([420,540],t0,0.1)
...
POK_bulb2_bedroom_1.windows([420,540],t0,0.1)
...
POK_bulb_BT_hallway_1.windows([450,570],t0,0.1)

POK_bulb_BT_hallway_2 = POK.Appliance(POK,2,10,1,30,0,30, wd_we_type = 1)
POK_bulb_BT_hallway_2.windows([960,1380],t0,0)
...
PMK_bulb_living_1_1 = PMK.Appliance(PMK,2,10,1,120,0,120)
PMK_bulb_living_1_1.windows([330,570],t0,0.1)

PMK_bulb_living_1_2 = PMK.Appliance(PMK,2,10,1,240,0,240)
PMK_bulb_living_1_2.windows([1140,1380],t0,0)

PMK_bulb_kitchen_1= PMK.Appliance(PMK,1,10,1,60,0,60)
...
PMK_bulb1_bedroom_1.windows([330,540],t0,0.1)
...
PMK_bulb2_bedroom_1.windows([330,480],t0,0.1)

PMK_bulb2_bedroom_2 = PMK.Appliance(PMK,1,10,1,60,0,60)
PMK_bulb2_bedroom_2.windows([960,1140],t0,0.1)

PMK_bulb2_bedroom_3 = PMK.Appliance(PMK,1,10,1,30,0,30)
PMK_bulb2_bedroom_3.windows([1140,1290],t0,0.1)

PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,3,10,1,30,0,15)
PMK_bulb_BT_hallway_1.windows(t1,t0,0.1)

PMK_bulb_BT_hallway_2 = PMK.Appliance(PMK,3,10,1,30,0,15)
PMK_bulb_BT_hallway_2.windows([1140,1380],t0,0)

PMK_outdoor_bulb_1 = PMK.Appliance(PMK,2,13,1,10,0.1,10)   # Meistens mit Bewegungssensor, deswegen nur 15 minuten
...
PMK_TV_2.windows([1170,1380],t0,0)
...
# PMK_Waschmaschine = PMK.Appliance(PMK,1,1000,2,60,0.1,60, thermal_P_var = 0.2, occasional_use = 0.43)
...
#%%'
#Paar Mit Kind
PMK_bulb_living_1 = PMK.Appliance(PMK,2,10,1,60,0,60, wd_we_type = 1)
PMK_bulb_living_1.windows([450,570],t0,0.1)

PMK_bulb_living_2 = PMK.Appliance(PMK,2,10,1,120,0,120, wd_we_type = 1)
PMK_bulb_living_2.windows(t2,t0,0.1)
...
PMK_bulb_kitchen_2 = PMK.Appliance(PMK,1,10,1,30,0,30, wd_we_type = 1)
PMK_bulb_kitchen_2.windows([960,1080],t0,0)
...
PMK_bulb1_bedroom_1.windows([420,540],t0,0.1)
...
PMK_bulb2_bedroom_1.windows([420,540],t0,0.1)

PMK_bulb2_bedroom_2 = PMK.Appliance(PMK,1,10,1,60,0,60, wd_we_type = 1)
...
PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,3,10,1,30,0,30, wd_we_type = 1)
PMK_bulb_BT_hallway_1.windows([450,570],t0,0.1)

PMK_bulb_BT_hallway_2 = PMK.Appliance(PMK,3,10,1,30,0,30, wd_we_type = 1)
PMK_bulb_BT_hallway_2.windows([960,1380],t0,0)

PMK_outdoor_bulb_1 = PMK.Appliance(PMK,2,13,1,10,0,10, wd_we_type = 1)   
PMK_outdoor_bulb_1.windows([0,510],t0,0)

PMK_outdoor_bulb_2 = PMK.Appliance(PMK,2,13,1,30,0,30, wd_we_type = 1)  
...
PMK_TV_3= PMK.Appliance(PMK,1,60,1,60,0.1,45, wd_we_type = 1)
...
PMK_Laptop_PC_charger_2 = PMK.Appliance(PMK,2,50,1,60,0.05,30, wd_we_type = 1)
...
# PMK_Waschmaschine = PMK.Appliance(PMK,1,1000,2,60,0.1,60, thermal_P_var = 0.2, occasional_use = 0.43, wd_we_type = 1)
# PMK_Waschmaschine.windows([540,720],[1020,1260],0.1)
