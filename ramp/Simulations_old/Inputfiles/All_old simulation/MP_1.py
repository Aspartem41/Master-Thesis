# -*- coding: utf-8 -*-
"""
Created on Mon Apr 24 14:40:14 2023
...
MP_bulb_living_1_2 = MP.Appliance(MP,2,10,1,300,0,300, wd_we_type = 1)
...
MP_bulb2_bedroom_2 = MP.Appliance(MP,1,10,1,60,0,60, wd_we_type = 1)
...
MP_bulb_BT_hallway_1 = MP.Appliance(MP,4,10,1,30,0,15, wd_we_type = 1)
MP_bulb_BT_hallway_1.windows(t11,t0,v1)

MP_bulb_BT_hallway_2 = MP.Appliance(MP,4,10,1,30,0,15, wd_we_type = 1)
MP_bulb_BT_hallway_2.windows([960,1440],t0,0)

MP_outdoor_bulb_1 = MP.Appliance(MP,2,13,1,10,0,10, wd_we_type = 1)   
MP_outdoor_bulb_1.windows([0,510],t0,0)

MP_outdoor_bulb_2 = MP.Appliance(MP,2,13,1,30,0,30, wd_we_type = 1)  
