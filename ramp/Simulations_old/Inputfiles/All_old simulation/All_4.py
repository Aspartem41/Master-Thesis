...
EP_bulb_living_1_2.windows([1020,1440],t0,v2)
...
EP_bulb_BT_hallway_2.windows([1020,1440],t0,v2)
...
EP_outdoor_bulb_2.windows([1020,1440],t0,v2)
...
AE_bulb_living_1_1 = AE.Appliance(AE,1,10,1,60,0,60, wd_we_type = 0)
AE_bulb_living_1_1.windows(t1,t0,v1)

AE_bulb_living_1_2 = AE.Appliance(AE,1,10,1,210,0,210, wd_we_type = 0)
...
AE_bulb_living_1_2.windows([1020,1440],t0,v2)
...
AE_bulb_BT_hallway_2.windows([1020,1440],t0,v2)
...
AE_outdoor_bulb_2.windows([1020,1440],t0,v2)
...
POK_bulb_living_1_1= POK.Appliance(POK,1,10,1,60,0,60, wd_we_type = 0)
POK_bulb_living_1_1.windows(t1,t0,v1)

POK_bulb_living_1_2 = POK.Appliance(POK,1,10,1,210,0,210, wd_we_type = 0)
POK_bulb_living_1_2.windows(t2,t0,0)

POK_bulb_kitchen_1= POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 0)
...
POK_bulb2_bedroom_2 = POK.Appliance(POK,1,10,1,20,0,20, wd_we_type = 0)
...
POK_bulb_BT_hallway_1 = POK.Appliance(POK,2,10,1,15,0,10, wd_we_type = 0)
POK_bulb_BT_hallway_1.windows(t1,t0,v1)

POK_bulb_BT_hallway_2 = POK.Appliance(POK,2,10,1,20,0,10, wd_we_type = 0)
POK_bulb_BT_hallway_2.windows(t2,t0,0)

POK_outdoor_bulb_1 = POK.Appliance(POK,1,13,1,5,0,5, wd_we_type = 0)   
...
POK_bulb_living_1_2.windows([1020,1440],t0,v2)
...
POK_bulb2_bedroom_2.windows([1020,1320],t0,v2)
...
POK_bulb_BT_hallway_2.windows([1020,1440],t0,v2)
...
POK_outdoor_bulb_2.windows([1020,1440],t0,v2)
...
PMK_bulb_living_1_2.windows([1020,1440],t0,v2)
...
PMK_bulb2_bedroom_2.windows([1020,1320],t0,v2)
...
PMK_bulb_BT_hallway_2.windows([1020,1440],t0,v2)
...
PMK_outdoor_bulb_2.windows([1020,1440],t0,v2)
...
MP_bulb_living_1_2.windows([1020,1440],t0,v2)
...
MP_bulb2_bedroom_2.windows([1020,1320],t0,v2)
...
MP_bulb_BT_hallway_2.windows([1020,1440],t0,v2)
...
MP_outdoor_bulb_2.windows([1020,1440],t0,v2)
