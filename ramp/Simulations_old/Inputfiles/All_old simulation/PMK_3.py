# -*- coding: utf-8 -*-
"""
Created on Thu Apr 13 13:55:44 2023
...
PMK_bulb_living_1_1= PMK.Appliance(PMK,2,10,1,120,0,120, wd_we_type = 1)
...
PMK_bulb_kitchen_3 = PMK.Appliance(PMK,1,10,1,60,0,60, wd_we_type = 1)
PMK_bulb_kitchen_3.windows([1200,1290],t0,v1)

PMK_bulb1_bedroom_1 = PMK.Appliance(PMK,1,10,1,60,0,60, wd_we_type = 1)
...
PMK_bulb2_bedroom_1 = PMK.Appliance(PMK,1,10,1,60,0,60, wd_we_type = 1)
...
PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,3,10,1,20,0,20, wd_we_type = 1)
...
PMK_outdoor_bulb_2 = PMK.Appliance(PMK,2,13,1,5,0,5, wd_we_type = 1)  
...
# PMK_bulb_living_1_1 = PMK.Appliance(PMK,2,10,1,30,0,30)
# PMK_bulb_living_1_1.windows(t1,t0,0.1)

# PMK_bulb_living_1_2 = PMK.Appliance(PMK,2,10,1,90,0,90)
# PMK_bulb_living_1_2.windows(t3,t0,0)

# PMK_bulb_kitchen_1= PMK.Appliance(PMK,1,10,1,15,0,15)
# PMK_bulb_kitchen_1.windows(t1,t0,0.1)

# PMK_bulb_kitchen_2= PMK.Appliance(PMK,1,10,1,45,0,45)
# PMK_bulb_kitchen_2.windows([1200,1290],t0,0.1)

# PMK_bulb1_bedroom_1= PMK.Appliance(PMK,1,10,1,30,0,30)
# PMK_bulb1_bedroom_1.windows(t1,t0,0.1)

# PMK_bulb1_bedroom_2= PMK.Appliance(PMK,1,10,1,30,0,30)
# PMK_bulb1_bedroom_2.windows(t2,t0,0)

# PMK_bulb2_bedroom_1 = PMK.Appliance(PMK,1,10,1,30,0,30)
# PMK_bulb2_bedroom_1.windows(t1,t0,0.1)

# PMK_bulb2_bedroom_2 = PMK.Appliance(PMK,1,10,1,30,0,30)
# PMK_bulb2_bedroom_2.windows(t2,t0,0)

# # PMK_bulb2_bedroom_3 = PMK.Appliance(PMK,1,10,1,30,0,30)
# # PMK_bulb2_bedroom_3.windows([1320,1440],t0,0.1)

# PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,3,10,1,5,0,5)
# PMK_bulb_BT_hallway_1.windows(t1,t0,0.1)

# PMK_bulb_BT_hallway_2 = PMK.Appliance(PMK,3,10,1,15,0,15)
# PMK_bulb_BT_hallway_2.windows(t3,t0,0.1)
...
# PMK_outdoor_bulb_2 = PMK.Appliance(PMK,2,13,1,5,0.1,5)   
# PMK_outdoor_bulb_2.windows([1290,1440],t0,0)
...
# PMK_Phone_charger_1.windows([330,450],t0,0)
...
# PMK_Laptop_PC_charger_1.windows([330,450],t0,0)
...
# # PMK_bulb_living_2 = PMK.Appliance(PMK,1,10,1,60,0.1,60, wd_we_type = 1)
# # PMK_bulb_living_2.windows([1080,1140],t0,0.1)

# PMK_bulb_living_3 = PMK.Appliance(PMK,2,10,1,120,0,120, wd_we_type = 1)
# PMK_bulb_living_3.windows(t2,t0,0)
...
# PMK_bulb_kitchen_3 = PMK.Appliance(PMK,1,10,1,60,0,60, wd_we_type = 1)
# PMK_bulb_kitchen_3.windows([1200,1290],t0,0.1)
...
# PMK_bulb_BT_hallway_1 = PMK.Appliance(PMK,3,10,1,5,0,5, wd_we_type = 1)
# PMK_bulb_BT_hallway_1.windows(t1,t0,0.1)

# PMK_bulb_BT_hallway_2 = PMK.Appliance(PMK,3,10,1,15,0,15, wd_we_type = 1)
# PMK_bulb_BT_hallway_2.windows(t3,t0,0.1)

# # PMK_outdoor_bulb_1 = PMK.Appliance(PMK,1,13,1,5,0.1,5, wd_we_type = 1)   # Meistens mit Bewegungssensor, deswegen nur 15 minuten
# # PMK_outdoor_bulb_1.windows([0,510],t0,0.1)

# PMK_outdoor_bulb_2 = PMK.Appliance(PMK,1,13,1,5,0.1,5, wd_we_type = 1)  
# PMK_outdoor_bulb_2.windows([1290,1440],t0,0.1)
