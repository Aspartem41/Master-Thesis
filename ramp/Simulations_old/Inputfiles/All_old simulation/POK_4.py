...
POK_bulb_living_1_2 = POK.Appliance(POK,1,10,1,210,0,210, wd_we_type = 1)
...
POK_bulb2_bedroom_2 = POK.Appliance(POK,1,10,1,20,0,20, wd_we_type = 1)
...
POK_bulb_BT_hallway_1 = POK.Appliance(POK,2,10,1,15,0,10, wd_we_type = 1)
POK_bulb_BT_hallway_1.windows(t11,t0,v1)

POK_bulb_BT_hallway_2 = POK.Appliance(POK,2,10,1,20,0,10, wd_we_type = 1)
...
# POK_bulb_living_1_1 = POK.Appliance(POK,1,10,1,60,0,60)
# POK_bulb_living_1_1.windows(t2,t0,0.1)

# POK_bulb_living_1_2 = POK.Appliance(POK,1,10,1,210,0,210)
# POK_bulb_living_1_2.windows([1140,1380],t0,0)

# POK_bulb_kitchen_1= POK.Appliance(POK,1,10,1,30,0,30)
...
# POK_bulb1_bedroom_1.windows(t2,t0,0.1)

# POK_bulb1_bedroom_2= POK.Appliance(POK,1,10,1,30,0,30)
# POK_bulb1_bedroom_2.windows([1320,1440],t0,0.1)

# POK_bulb2_bedroom_1 = POK.Appliance(POK,1,10,1,20,0,20)
# POK_bulb2_bedroom_1.windows([1140,1320],t0,0.1)

# # POK_bulb2_bedroom_2 = POK.Appliance(POK,1,10,1,30,0,30)
# # POK_bulb2_bedroom_2.windows([1140,1320],t0,0.1)

# POK_bulb_BT_hallway_1 = POK.Appliance(POK,2,10,1,15,0,15)
# POK_bulb_BT_hallway_1.windows(t1,t0,0.1)

# POK_bulb_BT_hallway_2 = POK.Appliance(POK,2,10,1,20,0,20)
...
# #%%'
# # Paar ohne Kind
# POK_bulb_living_1 = POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 1)
# POK_bulb_living_1.windows([450,510],t0,0.1)

# POK_bulb_living_2 = POK.Appliance(POK,1,10,1,60,0.1,60, wd_we_type = 1)
# POK_bulb_living_2.windows([1020,1140],t0,0.1)

# POK_bulb_living_3 = POK.Appliance(POK,1,10,1,180,0,180, wd_we_type = 1)
# POK_bulb_living_3.windows([1140,1440],t0,0)

# # POK_bulb_kitchen_1 = POK.Appliance(POK,1,7,1,30,0,30, wd_we_type = 1)
# # POK_bulb_kitchen_1.windows([450,540],t0,0.1)

# # POK_bulb_kitchen_2 = POK.Appliance(POK,1,10,1,15,0,15, wd_we_type = 1)
# # POK_bulb_kitchen_2.windows([1080,1110],t0,0.1)

# POK_bulb_kitchen_3 = POK.Appliance(POK,1,10,1,150,0,150, wd_we_type = 1)
# POK_bulb_kitchen_3.windows([1140,1320],t0,0.1)

# POK_bulb1_bedroom_1 = POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 1)
# POK_bulb1_bedroom_1.windows([420,510],t0,0.1)

# POK_bulb1_bedroom_2 = POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 1)
# POK_bulb1_bedroom_2.windows([1320,1440],t0,0.1)

# POK_bulb2_bedroom_1 = POK.Appliance(POK,1,10,1,20,0,20, wd_we_type = 1)
# POK_bulb2_bedroom_1.windows([1020,1320],t0,0)

# # POK_bulb2_bedroom_2 = POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 1)
# # POK_bulb2_bedroom_2.windows([1080,1290],t0,0.1)

# POK_bulb_BT_hallway_1 = POK.Appliance(POK,2,10,1,15,0,15, wd_we_type = 1)
# POK_bulb_BT_hallway_1.windows([450,510],t0,0.1)

# POK_bulb_BT_hallway_2 = POK.Appliance(POK,2,10,1,20,0,20, wd_we_type = 1)
# POK_bulb_BT_hallway_2.windows([1020,1380],t0,0)

# POK_outdoor_bulb_1 = POK.Appliance(POK,1,13,1,10,0.1,10, wd_we_type = 1)   # Meistens mit Bewegungssensor, deswegen nur 15 minuten
# POK_outdoor_bulb_1.windows([0,510],t0,0)

# POK_outdoor_bulb_2 = POK.Appliance(POK,1,13,1,10,0.1,10, wd_we_type = 1)  
# POK_outdoor_bulb_2.windows([1020,1440],t0,0)
...
# POK_TV_3 = POK.Appliance(POK,1,60,1,60,0.1,60, wd_we_type = 1)
