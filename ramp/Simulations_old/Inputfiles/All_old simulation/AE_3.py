# -*- coding: utf-8 -*-
"""
Created on Tue May  2 11:23:53 2023
...
AE_bulb_living_1_1= AE.Appliance(AE,1,10,1,120,0,120, wd_we_type = 1)
...
AE_bulb_kitchen_3 = AE.Appliance(AE,1,10,1,60,0,60, wd_we_type = 1)
AE_bulb_kitchen_3.windows([1200,1290],t0,v1)

AE_bulb1_bedroom_1 = AE.Appliance(AE,1,10,1,60,0,60, wd_we_type = 1)
...
AE_outdoor_bulb_2 = AE.Appliance(AE,1,13,1,5,0,5, wd_we_type = 1)  
