# -*- coding: utf-8 -*-
"""
Created on Tue May  2 11:16:31 2023
...
AE_bulb_living_1_1= AE.Appliance(AE,1,10,1,60,0,60, wd_we_type = 1)
AE_bulb_living_1_1.windows(t11,t0,v1)

AE_bulb_living_1_2 = AE.Appliance(AE,1,10,1,300,0,300, wd_we_type = 1)
AE_bulb_living_1_2.windows([960,1440],t0,0)

AE_bulb_kitchen_1 = AE.Appliance(AE,1,10,1,30,0,30, wd_we_type = 1)
AE_bulb_kitchen_1.windows(t11,t0,v1)

AE_bulb_kitchen_2 = AE.Appliance(AE,1,10,1,30,0,30, wd_we_type = 1)
AE_bulb_kitchen_2.windows([960,1140],t0,v1)

AE_bulb_kitchen_3 = AE.Appliance(AE,1,10,1,120,0,120, wd_we_type = 1)
...
AE_outdoor_bulb_1 = AE.Appliance(AE,1,13,1,10,0,10, wd_we_type = 1)   
AE_outdoor_bulb_1.windows([0,510],t0,0)

AE_outdoor_bulb_2 = AE.Appliance(AE,1,13,1,10,0,10, wd_we_type = 1)  
