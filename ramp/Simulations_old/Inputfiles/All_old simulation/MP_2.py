...
MP_bulb_living_1_1= MP.Appliance(MP,2,10,1,30,0,30, wd_we_type = 1)
...
MP_bulb_kitchen_3 = MP.Appliance(MP,2,10,1,100,0,100, wd_we_type = 1)
...
MP_bulb_BT_hallway_1 = MP.Appliance(MP,4,10,1,10,0,10, wd_we_type = 1)
...
MP_outdoor_bulb_1 = MP.Appliance(MP,2,13,1,5,0,5, wd_we_type = 1)   
MP_outdoor_bulb_1.windows([0,510],t0,0)
...
MP_TV_2= MP.Appliance(MP,1,60,1,30,v1,30, wd_we_type = 1)
MP_TV_2.windows([840,1020],t0,v1)

MP_TV_3= MP.Appliance(MP,1,60,1,60,v1,45, wd_we_type = 1)
