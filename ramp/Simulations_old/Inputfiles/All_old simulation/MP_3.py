# -*- coding: utf-8 -*-
"""
Created on Tue Apr 25 15:55:34 2023
...
MP_bulb_living_1_1= MP.Appliance(MP,2,10,1,120,0,120, wd_we_type = 1)
...
MP_bulb_kitchen_3 = MP.Appliance(MP,2,10,1,60,0,60, wd_we_type = 1)
MP_bulb_kitchen_3.windows([1200,1290],t0,v1)

MP_bulb1_bedroom_1 = MP.Appliance(MP,1,10,1,60,0,60, wd_we_type = 1)
...
MP_bulb2_bedroom_1 = MP.Appliance(MP,1,10,1,60,0,60, wd_we_type = 1)
...
MP_bulb3_bedroom_1 = MP.Appliance(MP,1,10,1,60,0,60, wd_we_type = 1)
...
MP_bulb_BT_hallway_1 = MP.Appliance(MP,4,10,1,20,0,20, wd_we_type = 1)
...
MP_outdoor_bulb_2 = MP.Appliance(MP,2,13,1,5,0,5, wd_we_type = 1)  
