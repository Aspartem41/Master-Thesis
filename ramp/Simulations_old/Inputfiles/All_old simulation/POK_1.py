...
POK_bulb_living_1_1= POK.Appliance(POK,1,10,1,60,0,60, wd_we_type = 1)
POK_bulb_living_1_1.windows(t11,t0,v1)

POK_bulb_living_1_2 = POK.Appliance(POK,1,10,1,300,0,300, wd_we_type = 1)
...
POK_bulb_kitchen_3 = POK.Appliance(POK,1,10,1,120,0,120, wd_we_type = 1)
POK_bulb_kitchen_3.windows(t22,t0,v1)
...
POK_bulb2_bedroom_1 = POK.Appliance(POK,1,10,1,15,0,15, wd_we_type = 1)
...
POK_bulb_BT_hallway_1 = POK.Appliance(POK,2,10,1,30,0,15, wd_we_type = 1)
POK_bulb_BT_hallway_1.windows(t11,t0,v1)

POK_bulb_BT_hallway_2 = POK.Appliance(POK,2,10,1,30,0,15, wd_we_type = 1)
POK_bulb_BT_hallway_2.windows([960,1440],t0,0)

POK_outdoor_bulb_1 = POK.Appliance(POK,1,13,1,10,0,10, wd_we_type = 1)   
POK_outdoor_bulb_1.windows([0,510],t0,0)

POK_outdoor_bulb_2 = POK.Appliance(POK,1,13,1,10,0,10, wd_we_type = 1)  
...
# POK_bulb_kitchen_2= POK.Appliance(POK,1,10,1,120,0,120, wd_we_type = 0)
# POK_bulb_kitchen_2.windows(t2,t0,0.1)

# POK_bulb1_bedroom_1= POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 0)
# POK_bulb1_bedroom_1.windows(t1,t0,0.1)

# POK_bulb1_bedroom_2= POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 0)
# POK_bulb1_bedroom_2.windows([1320,1380],t0,0.1)

# POK_bulb2_bedroom_1 = POK.Appliance(POK,1,10,1,15,0,15, wd_we_type = 0)
# POK_bulb2_bedroom_1.windows(t1,t0,0.1)

# POK_bulb2_bedroom_2 = POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 0)
# POK_bulb2_bedroom_2.windows([1140,1320],t0,0.1)
...
# POK_outdoor_bulb_1 = POK.Appliance(POK,1,13,1,10,0.1,10, wd_we_type = 0)   # Meistens mit Bewegungssensor, deswegen nur 20 minuten
# POK_outdoor_bulb_1.windows([0,510],t0,0)

# POK_outdoor_bulb_2 = POK.Appliance(POK,1,13,1,10,0.1,10, wd_we_type = 0)   
# POK_outdoor_bulb_2.windows(t22,t0,0)

# POK_TV = POK.Appliance(POK,1,60,1,90,0.1,75, wd_we_type = 0)
# POK_TV.windows(t2,t0,0.1)

# POK_Phone_charger_1 = POK.Appliance(POK,2,5,1,45,0.1,45, wd_we_type = 0)
# POK_Phone_charger_1.windows([390,450],t0,0)

# POK_Phone_charger_2 = POK.Appliance(POK,2,5,1,15,0.1,15, wd_we_type = 0)
# POK_Phone_charger_2.windows(t2,t0,0.1)

# POK_Laptop_PC_charger_1 = POK.Appliance(POK,2,50,1,30,0.05,30, wd_we_type = 0)
# POK_Laptop_PC_charger_1.windows([390,450],t0,0)

# POK_Laptop_PC_charger_2 = POK.Appliance(POK,2,50,1,30,0.05,30, wd_we_type = 0)
# POK_Laptop_PC_charger_2.windows(t2,t0,0.1)

# POK_Herd = POK.Appliance(POK,1,1800,1,15,0.1,15, thermal_P_var = 0.2, fixed_cycle=1, pref_index = 0, wd_we_type = 0)
# POK_Herd.windows([420,540],t0,0.1)
# POK_Herd.specific_cycle_1(1800,10,750,5,0.15)
# POK_Herd.cycle_behaviour(t11,t0)

# POK_Herd = POK.Appliance(POK,1,1800,1,45,0.1,30, thermal_P_var = 0.2, fixed_cycle=1, pref_index = 0, wd_we_type = 0)
# POK_Herd.windows([1140,1260],t0,0.1)
# POK_Herd.specific_cycle_1(1800,30,750,15,0.15)
# POK_Herd.cycle_behaviour([1140,1260],t0)
...
# POK_bulb_living_1.windows(t11,t0,0.1)

# POK_bulb_living_2 = POK.Appliance(POK,1,10,1,300,0,300, wd_we_type = 1)
# POK_bulb_living_2.windows([960,1440],t0,0)

# # POK_bulb_living_3 = POK.Appliance(POK,1,10,1,180,0,180, wd_we_type = 1)
# # POK_bulb_living_3.windows(t22,t0,0)

# POK_bulb_kitchen_1 = POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 1)
# POK_bulb_kitchen_1.windows(t11,t0,0.1)

# POK_bulb_kitchen_2 = POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 1)
# POK_bulb_kitchen_2.windows([960,1140],t0,0.1)

# POK_bulb_kitchen_3 = POK.Appliance(POK,1,10,1,120,0,120, wd_we_type = 1)
# POK_bulb_kitchen_3.windows(t22,t0,0.1)

# POK_bulb1_bedroom_1 = POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 1)
# POK_bulb1_bedroom_1.windows(t11,t0,0.1)

# POK_bulb1_bedroom_2 = POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 1)
# POK_bulb1_bedroom_2.windows([1320,1440],t0,0.1)

# POK_bulb2_bedroom_1 = POK.Appliance(POK,1,10,1,15,0,15, wd_we_type = 1)
# POK_bulb2_bedroom_1.windows(t11,t0,0.1)

# POK_bulb2_bedroom_2 = POK.Appliance(POK,1,10,1,15,0,15, wd_we_type = 1)
# POK_bulb2_bedroom_2.windows([960,1320],t0,0)

# POK_bulb_BT_hallway_1 = POK.Appliance(POK,2,10,1,30,0,30, wd_we_type = 1)
# POK_bulb_BT_hallway_1.windows(t11,t0,0.1)

# POK_bulb_BT_hallway_2 = POK.Appliance(POK,2,10,1,30,0,30, wd_we_type = 1)
# POK_bulb_BT_hallway_2.windows([960,1440],t0,0)
...
# POK_TV_2.windows([840,1020],t0,0.1)
...
# POK_Phone_charger_1.windows([540,720],t0,0.1)

# POK_Phone_charger_2 = POK.Appliance(POK,2,5,1,15,0.1,15, wd_we_type = 1)
# POK_Phone_charger_2.windows(t22,t0,0)

# POK_Laptop_PC_charger_1 = POK.Appliance(POK,2,50,1,30,0.05,30, wd_we_type = 1)
# POK_Laptop_PC_charger_1.windows([540,720],t0,0.1)
...
# POK_Herd = POK.Appliance(POK,1,1800,1,15,0.1,15, thermal_P_var = 0.2, fixed_cycle=1, pref_index = 0, wd_we_type = 1)
# POK_Herd.windows([480,600],t0,0.1)
# POK_Herd.specific_cycle_1(1800,10,750,5,0.15)
# POK_Herd.cycle_behaviour([480,600],t0)

# POK_Herd = POK.Appliance(POK,1,1800,1,45,0.1,45, thermal_P_var = 0.2, fixed_cycle=1, pref_index = 0, wd_we_type = 1)
# POK_Herd.windows([660,780],t0,0.1)
# POK_Herd.specific_cycle_1(1800,10,750,35,0.15)
# POK_Herd.cycle_behaviour([660,780],t0)

# POK_Herd = POK.Appliance(POK,1,1800,1,10,0.1,10, thermal_P_var = 0.2, fixed_cycle=1, pref_index = 0, wd_we_type = 1)
# POK_Herd.windows([900,1020],t0,0.1)
# POK_Herd.specific_cycle_1(1800,10,0.15)
# POK_Herd.cycle_behaviour([900,1020],t0)
...
# #%%
# # Occasional used devices

# POK_Mixer = POK.Appliance(POK,1,50,2,15,0.1,10, occasional_use = 0.33)
# POK_Mixer.windows([420,540],[1140,1260],0.1)

# POK_Toaster = POK.Appliance(POK,1,1000,2,10,0.1,10, occasional_use = 0.8)
# POK_Toaster.windows([420,540],[1140,1260],0.1)
...
# POK_Luftfritteuse.windows([420,540],[1140,1260], 0.1)
...
# POK_Ofen = POK.Appliance(POK,1,2150,2,60,0.1,60, thermal_P_var = 0.2, occasional_use= 0.5)
# POK_Ofen.windows([420,540],[1140,1260],0.1)
