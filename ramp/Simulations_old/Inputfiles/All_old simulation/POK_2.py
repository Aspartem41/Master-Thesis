...
POK_bulb_living_1_1= POK.Appliance(POK,1,10,1,30,0,30, wd_we_type = 1)
POK_bulb_living_1_1.windows(t11,t0,v1)

POK_bulb_living_1_2 = POK.Appliance(POK,1,10,1,150,0,150, wd_we_type = 1)
...
POK_bulb2_bedroom_2 = POK.Appliance(POK,1,10,1,10,0,10, wd_we_type = 1)
